...
80100049:	e8 1a 4e 00 00       	call   80104e68 <initlock>
...
801000bd:	e8 c7 4d 00 00       	call   80104e89 <acquire>
...
80100104:	e8 e2 4d 00 00       	call   80104eeb <release>
        return b;
...
8010017c:	e8 6a 4d 00 00       	call   80104eeb <release>
      return b;
...
80100198:	c7 04 24 5b 84 10 80 	movl   $0x8010845b,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 6c 84 10 80 	movl   $0x8010846c,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 73 84 10 80 	movl   $0x80108473,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023c:	e8 48 4c 00 00       	call   80104e89 <acquire>
...
801002a9:	e8 3d 4c 00 00       	call   80104eeb <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 c9 4a 00 00       	call   80104e89 <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 7a 84 10 80 	movl   $0x8010847a,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 83 84 10 80 	movl   $0x80108483,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 b3 49 00 00       	call   80104eeb <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 8a 84 10 80 	movl   $0x8010848a,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 99 84 10 80 	movl   $0x80108499,(%esp)
...
8010058f:	e8 a6 49 00 00       	call   80104f3a <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 9b 84 10 80 	movl   $0x8010849b,(%esp)
...
801006b2:	e8 f5 4a 00 00       	call   801051ac <memmove>
    pos -= 80;
...
801006e1:	e8 f7 49 00 00       	call   801050dd <memset>
  }
...
80100776:	e8 19 63 00 00       	call   80106a94 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 0d 63 00 00       	call   80106a94 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 01 63 00 00       	call   80106a94 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 f4 62 00 00       	call   80106a94 <uartputc>
  cgaputc(c);
...
801007ba:	e8 ca 46 00 00       	call   80104e89 <acquire>
  while((c = getc()) >= 0){
...
80100914:	e8 d2 45 00 00       	call   80104eeb <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 4b 45 00 00       	call   80104e89 <acquire>
  while(n > 0){
...
80100959:	e8 8d 45 00 00       	call   80104eeb <release>
        ilock(ip);
...
801009fe:	e8 e8 44 00 00       	call   80104eeb <release>
  ilock(ip);
...
80100a32:	e8 52 44 00 00       	call   80104e89 <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 7a 44 00 00       	call   80104eeb <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 9f 84 10 	movl   $0x8010849f,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100a96:	e8 cd 43 00 00       	call   80104e68 <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 a7 84 10 	movl   $0x801084a7,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 80 07 11 80 	movl   $0x80110780,(%esp)
80100aaa:	e8 b9 43 00 00       	call   80104e68 <initlock>
...
80100b6e:	e9 69 03 00 00       	jmp    80100edc <exec+0x3ed>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 6d 70 00 00       	call   80107be5 <setupkvm>
...
80100c14:	e8 9a 73 00 00       	call   80107fb3 <allocuvm>
...
80100c52:	e8 71 72 00 00       	call   80107ec8 <loaduvm>
...
80100cc0:	e8 ee 72 00 00       	call   80107fb3 <allocuvm>
...
80100ce5:	e8 f9 74 00 00       	call   801081e3 <clearpteu>
  sp = sz;
...
80100d1b:	e8 27 46 00 00       	call   80105347 <strlen>
...
80100d44:	e8 fe 45 00 00       	call   80105347 <strlen>
...
80100d74:	e8 2f 76 00 00       	call   801083a8 <copyout>
...
80100e1b:	e8 88 75 00 00       	call   801083a8 <copyout>
...
80100e73:	e8 85 44 00 00       	call   801052fd <safestrcpy>
...
80100ec5:	e8 0c 6e 00 00       	call   80107cd6 <switchuvm>
  freevm(oldpgdir);
80100eca:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ecd:	89 04 24             	mov    %eax,(%esp)
80100ed0:	e8 74 72 00 00       	call   80108149 <freevm>
  return 0;
...
80100ee8:	e8 5c 72 00 00       	call   80108149 <freevm>
  if(ip){
...
80100f10:	c7 44 24 04 ad 84 10 	movl   $0x801084ad,0x4(%esp)
80100f17:	80 
80100f18:	c7 04 24 40 08 11 80 	movl   $0x80110840,(%esp)
80100f1f:	e8 44 3f 00 00       	call   80104e68 <initlock>
}
80100f24:	c9                   	leave  
80100f25:	c3                   	ret    
...
80100f33:	e8 51 3f 00 00       	call   80104e89 <acquire>
...
80100f5c:	e8 8a 3f 00 00       	call   80104eeb <release>
      return f;
...
80100f7a:	e8 6c 3f 00 00       	call   80104eeb <release>
  return 0;
...
80100f93:	e8 f1 3e 00 00       	call   80104e89 <acquire>
  if(f->ref < 1)
...
80100fa0:	7f 0c                	jg     80100fae <filedup+0x28>
    panic("filedup");
80100fa2:	c7 04 24 b4 84 10 80 	movl   $0x801084b4,(%esp)
...
80100fc4:	e8 22 3f 00 00       	call   80104eeb <release>
  return f;
...
80100fdb:	e8 a9 3e 00 00       	call   80104e89 <acquire>
  if(f->ref < 1)
...
80100fe8:	7f 0c                	jg     80100ff6 <fileclose+0x28>
    panic("fileclose");
80100fea:	c7 04 24 bc 84 10 80 	movl   $0x801084bc,(%esp)
...
80101016:	e8 d0 3e 00 00       	call   80104eeb <release>
...
80101060:	e8 86 3e 00 00       	call   80104eeb <release>
...
8010119f:	eb 0c                	jmp    801011ad <fileread+0xba>
  ...
  panic("fileread");
801011a1:	c7 04 24 c6 84 10 80 	movl   $0x801084c6,(%esp)
...
801012ad:	c7 04 24 cf 84 10 80 	movl   $0x801084cf,(%esp)
...
801012dd:	eb 0c                	jmp    801012eb <filewrite+0x13c>
  ...
  panic("filewrite");
801012df:	c7 04 24 df 84 10 80 	movl   $0x801084df,(%esp)
...
80101325:	e8 82 3e 00 00       	call   801051ac <memmove>
  brelse(bp);
...
8010136b:	e8 6d 3d 00 00       	call   801050dd <memset>
  log_write(bp);
...
801014b8:	c7 04 24 ec 84 10 80 	movl   $0x801084ec,(%esp)
...
80101547:	c7 04 24 02 85 10 80 	movl   $0x80108502,(%esp)
...
8010159a:	c7 44 24 04 15 85 10 	movl   $0x80108515,0x4(%esp)
801015a1:	80 
801015a2:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
801015a9:	e8 ba 38 00 00       	call   80104e68 <initlock>
  readsb(dev, &sb);
...
8010160e:	c7 04 24 1c 85 10 80 	movl   $0x8010851c,(%esp)
...
80101691:	e8 47 3a 00 00       	call   801050dd <memset>
      dip->type = type;
...
801016e9:	c7 04 24 6f 85 10 80 	movl   $0x8010856f,(%esp)
...
80101798:	e8 0f 3a 00 00       	call   801051ac <memmove>
  log_write(bp);
...
801017c2:	e8 c2 36 00 00       	call   80104e89 <acquire>
...
8010180c:	e8 da 36 00 00       	call   80104eeb <release>
      return ip;
...
8010183f:	c7 04 24 81 85 10 80 	movl   $0x80108581,(%esp)
...
8010187d:	e8 69 36 00 00       	call   80104eeb <release>
...
80101894:	e8 f0 35 00 00       	call   80104e89 <acquire>
  ip->ref++;
...
801018af:	e8 37 36 00 00       	call   80104eeb <release>
  return ip;
...
801018cd:	7f 0c                	jg     801018db <ilock+0x22>
    panic("ilock");
801018cf:	c7 04 24 91 85 10 80 	movl   $0x80108591,(%esp)
801018d6:	e8 5f ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801018db:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
801018e2:	e8 a2 35 00 00       	call   80104e89 <acquire>
...
80101921:	e8 c5 35 00 00       	call   80104eeb <release>
...
801019d2:	e8 d5 37 00 00       	call   801051ac <memmove>
    brelse(bp);
...
801019fd:	75 0c                	jne    80101a0b <ilock+0x152>
      panic("ilock: no type");
801019ff:	c7 04 24 97 85 10 80 	movl   $0x80108597,(%esp)
...
80101a2e:	7f 0c                	jg     80101a3c <iunlock+0x2f>
    panic("iunlock");
80101a30:	c7 04 24 a6 85 10 80 	movl   $0x801085a6,(%esp)
80101a37:	e8 fe ea ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
80101a3c:	c7 04 24 60 12 11 80 	movl   $0x80111260,(%esp)
80101a43:	e8 41 34 00 00       	call   80104e89 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a6b:	e8 7b 34 00 00       	call   80104eeb <release>
}
80101a70:	c9                   	leave  
80101a71:	c3                   	ret    
...
80101a7f:	e8 05 34 00 00       	call   80104e89 <acquire>
...
80101abb:	74 0c                	je     80101ac9 <iput+0x57>
      panic("iput busy");
80101abd:	c7 04 24 ae 85 10 80 	movl   $0x801085ae,(%esp)
...
80101ae1:	e8 05 34 00 00       	call   80104eeb <release>
    itrunc(ip);
...
80101b0c:	e8 78 33 00 00       	call   80104e89 <acquire>
    ip->flags = 0;
...
80101b3c:	e8 aa 33 00 00       	call   80104eeb <release>
}
80101b41:	c9                   	leave  
80101b42:	c3                   	ret    
...
80101c5c:	c7 04 24 b8 85 10 80 	movl   $0x801085b8,(%esp)
...
80101efd:	e8 aa 32 00 00       	call   801051ac <memmove>
    brelse(bp);
...
8010205c:	e8 4b 31 00 00       	call   801051ac <memmove>
    log_write(bp);
...
801020da:	e8 70 31 00 00       	call   8010524f <strncmp>
}
801020df:	c9                   	leave  
801020e0:	c3                   	ret    
...
801020f4:	c7 04 24 cb 85 10 80 	movl   $0x801085cb,(%esp)
...
80102130:	74 0c                	je     8010213e <dirlookup+0x5d>
      panic("dirlink read");
80102132:	c7 04 24 dd 85 10 80 	movl   $0x801085dd,(%esp)
...
80102215:	74 0c                	je     80102223 <dirlink+0x79>
      panic("dirlink read");
80102217:	c7 04 24 dd 85 10 80 	movl   $0x801085dd,(%esp)
...
8010225c:	e8 44 30 00 00       	call   801052a5 <strncpy>
  de.inum = inum;
...
8010228c:	74 0c                	je     8010229a <dirlink+0xf0>
    panic("dirlink");
8010228e:	c7 04 24 ea 85 10 80 	movl   $0x801085ea,(%esp)
...
80102313:	e8 94 2e 00 00       	call   801051ac <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
8010232e:	e8 79 2e 00 00       	call   801051ac <memmove>
    name[len] = 0;
...
8010257d:	c7 44 24 04 f2 85 10 	movl   $0x801085f2,0x4(%esp)
80102584:	80 
80102585:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
8010258c:	e8 d7 28 00 00       	call   80104e68 <initlock>
  picenable(IRQ_IDE);
...
80102627:	75 0c                	jne    80102635 <idestart+0x18>
    panic("idestart");
80102629:	c7 04 24 f6 85 10 80 	movl   $0x801085f6,(%esp)
...
80102642:	c7 04 24 ff 85 10 80 	movl   $0x801085ff,(%esp)
...
8010266a:	c7 04 24 f6 85 10 80 	movl   $0x801085f6,(%esp)
...
80102786:	e8 fe 26 00 00       	call   80104e89 <acquire>
  if((b = idequeue) == 0){
...
801027a0:	e8 46 27 00 00       	call   80104eeb <release>
...
80102835:	e8 b1 26 00 00       	call   80104eeb <release>
}
8010283a:	c9                   	leave  
8010283b:	c3                   	ret    
...
8010284e:	c7 04 24 11 86 10 80 	movl   $0x80108611,(%esp)
...
80102867:	c7 04 24 25 86 10 80 	movl   $0x80108625,(%esp)
...
8010290d:	e8 d9 25 00 00       	call   80104eeb <release>
}
80102912:	c9                   	leave  
80102913:	c3                   	ret    
...
8010299b:	c7 04 24 58 86 10 80 	movl   $0x80108658,(%esp)
...
80102a55:	c7 44 24 04 8a 86 10 	movl   $0x8010868a,0x4(%esp)
80102a5c:	80 
80102a5d:	c7 04 24 40 22 11 80 	movl   $0x80112240,(%esp)
80102a64:	e8 ff 23 00 00       	call   80104e68 <initlock>
  kmem.use_lock = 0;
...
80102b0f:	76 0c                	jbe    80102b1d <kfree+0x39>
    panic("kfree");
80102b11:	c7 04 24 8f 86 10 80 	movl   $0x8010868f,(%esp)
...
80102b33:	e8 a5 25 00 00       	call   801050dd <memset>
...
80102b48:	e8 3c 23 00 00       	call   80104e89 <acquire>
  r = (struct run*)v;
...
80102b76:	e8 70 23 00 00       	call   80104eeb <release>
}
80102b7b:	c9                   	leave  
80102b7c:	c3                   	ret    
...
80102b93:	e8 f1 22 00 00       	call   80104e89 <acquire>
  r = kmem.freelist;
...
80102bc0:	e8 26 23 00 00       	call   80104eeb <release>
  return (char*)r;
...
80102f40:	c7 04 24 98 86 10 80 	movl   $0x80108698,(%esp)
...
801031a3:	e8 ac 1f 00 00       	call   80105154 <memcmp>
...
801032a3:	c7 44 24 04 c4 86 10 	movl   $0x801086c4,0x4(%esp)
801032aa:	80 
801032ab:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801032b2:	e8 b1 1b 00 00       	call   80104e68 <initlock>
  readsb(dev, &sb);
...
8010335c:	e8 4b 1e 00 00       	call   801051ac <memmove>
...
801034ae:	e8 d6 19 00 00       	call   80104e89 <acquire>
  while(1){
    if(log.committing){
...
8010351a:	e8 cc 19 00 00       	call   80104eeb <release>
      break;
...
80103539:	e8 4b 19 00 00       	call   80104e89 <acquire>
  log.outstanding -= 1;
...
80103554:	c7 04 24 c8 86 10 80 	movl   $0x801086c8,(%esp)
...
8010358f:	e8 57 19 00 00       	call   80104eeb <release>
...
801035a6:	e8 de 18 00 00       	call   80104e89 <acquire>
    log.committing = 0;
...
801035c8:	e8 1e 19 00 00       	call   80104eeb <release>
  }
}
801035cd:	c9                   	leave  
801035ce:	c3                   	ret    
...
80103643:	e8 64 1b 00 00       	call   801051ac <memmove>
...
801036ce:	c7 04 24 d7 86 10 80 	movl   $0x801086d7,(%esp)
...
801036e3:	c7 04 24 ed 86 10 80 	movl   $0x801086ed,(%esp)
801036ea:	e8 4b ce ff ff       	call   8010053a <panic>

  acquire(&log.lock);
801036ef:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801036f6:	e8 8e 17 00 00       	call   80104e89 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
8010376d:	e8 79 17 00 00       	call   80104eeb <release>
}
80103772:	c9                   	leave  
80103773:	c3                   	ret    
...
801037e9:	c7 04 24 08 87 10 80 	movl   $0x80108708,(%esp)
...
80103804:	e8 7b 31 00 00       	call   80106984 <uartinit>
  pinit();         // process table
80103809:	e8 6a 0b 00 00       	call   80104378 <pinit>
  tvinit();        // trap vectors
8010380e:	e8 23 2d 00 00       	call   80106536 <tvinit>
  binit();         // buffer cache
...
8010382b:	e8 51 2c 00 00       	call   80106481 <timerinit>
...
80103856:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103859:	e8 5b 44 00 00       	call   80107cb9 <switchkvm>
  seginit();
8010385e:	e8 d2 3d 00 00       	call   80107635 <seginit>
  lapicinit();
...
80103883:	c7 04 24 1f 87 10 80 	movl   $0x8010871f,(%esp)
8010388a:	e8 11 cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
8010388f:	e8 16 2e 00 00       	call   801066aa <idtinit>
...
801038e1:	e8 c6 18 00 00       	call   801051ac <memmove>
...
80103a62:	00 
80103a63:	c7 44 24 04 30 87 10 	movl   $0x80108730,0x4(%esp)
80103a6a:	80 
80103a6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a6e:	89 04 24             	mov    %eax,(%esp)
80103a71:	e8 de 16 00 00       	call   80105154 <memcmp>
...
80103ba3:	00 
80103ba4:	c7 44 24 04 35 87 10 	movl   $0x80108735,0x4(%esp)
80103bab:	80 
80103bac:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103baf:	89 04 24             	mov    %eax,(%esp)
80103bb2:	e8 9d 15 00 00       	call   80105154 <memcmp>
...
80103c80:	8b 04 85 78 87 10 80 	mov    -0x7fef7888(,%eax,4),%eax
...
80103cb9:	c7 04 24 3a 87 10 80 	movl   $0x8010873a,(%esp)
...
80103d4c:	c7 04 24 58 87 10 80 	movl   $0x80108758,(%esp)
...
80104045:	c7 44 24 04 8c 87 10 	movl   $0x8010878c,0x4(%esp)
8010404c:	80 
8010404d:	89 04 24             	mov    %eax,(%esp)
80104050:	e8 13 0e 00 00       	call   80104e68 <initlock>
  (*f0)->type = FD_PIPE;
...
801040fc:	e8 88 0d 00 00       	call   80104e89 <acquire>
  if(writable){
...
80104163:	e8 83 0d 00 00       	call   80104eeb <release>
    kfree((char*)p);
...
8010417b:	e8 6b 0d 00 00       	call   80104eeb <release>
}
80104180:	c9                   	leave  
80104181:	c3                   	ret    
...
8010418e:	e8 f6 0c 00 00       	call   80104e89 <acquire>
  for(i = 0; i < n; i++){
...
801041c1:	e8 25 0d 00 00       	call   80104eeb <release>
        return -1;
...
80104267:	e8 7f 0c 00 00       	call   80104eeb <release>
  return n;
...
8010427e:	e8 06 0c 00 00       	call   80104e89 <acquire>
...
80104298:	e8 4e 0c 00 00       	call   80104eeb <release>
      return -1;
...
80104354:	e8 92 0b 00 00       	call   80104eeb <release>
  return i;
...
8010437e:	c7 44 24 04 91 87 10 	movl   $0x80108791,0x4(%esp)
80104385:	80 
80104386:	c7 04 24 80 29 11 80 	movl   $0x80112980,(%esp)
8010438d:	e8 d6 0a 00 00       	call   80104e68 <initlock>
}
80104392:	c9                   	leave  
80104393:	c3                   	ret    
...
801043a1:	e8 e3 0a 00 00       	call   80104e89 <acquire>
...
8010440f:	e8 d7 0a 00 00       	call   80104eeb <release>
  return 0;
...
8010444b:	ba f1 64 10 80       	mov    $0x801064f1,%edx
...
8010447b:	e8 5d 0c 00 00       	call   801050dd <memset>
...
801044a9:	e8 37 37 00 00       	call   80107be5 <setupkvm>
...
801044be:	c7 04 24 98 87 10 80 	movl   $0x80108798,(%esp)
...
801044e4:	e8 54 39 00 00       	call   80107e3d <inituvm>
  p->sz = PGSIZE;
...
8010450b:	e8 cd 0b 00 00       	call   801050dd <memset>
...
80104584:	00 
80104585:	c7 44 24 04 b1 87 10 	movl   $0x801087b1,0x4(%esp)
8010458c:	80 
8010458d:	89 04 24             	mov    %eax,(%esp)
80104590:	e8 68 0d 00 00       	call   801052fd <safestrcpy>
  p->cwd = namei("/");
80104595:	c7 04 24 ba 87 10 80 	movl   $0x801087ba,(%esp)
...
801045e9:	e8 c5 39 00 00       	call   80107fb3 <allocuvm>
...
80104623:	e8 65 3a 00 00       	call   8010808d <deallocuvm>
...
8010464c:	e8 85 36 00 00       	call   80107cd6 <switchuvm>
  return 0;
...
80104691:	e8 93 3b 00 00       	call   80108229 <copyuvm>
...
80104798:	e8 60 0b 00 00       	call   801052fd <safestrcpy>
...
801047ad:	e8 d7 06 00 00       	call   80104e89 <acquire>
  np->state = RUNNABLE;
...
801047c3:	e8 23 07 00 00       	call   80104eeb <release>
...
801047e7:	75 0c                	jne    801047f5 <exit+0x22>
    panic("init exiting");
801047e9:	c7 04 24 bc 87 10 80 	movl   $0x801087bc,(%esp)
...
80104877:	e8 0d 06 00 00       	call   80104e89 <acquire>
...
801048e4:	e8 b3 01 00 00       	call   80104a9c <sched>
  panic("zombie exit");
801048e9:	c7 04 24 c9 87 10 80 	movl   $0x801087c9,(%esp)
...
80104902:	e8 82 05 00 00       	call   80104e89 <acquire>
  for(;;){
...
8010496b:	e8 d9 37 00 00       	call   80108149 <freevm>
        p->state = UNUSED;
...
801049a6:	e8 40 05 00 00       	call   80104eeb <release>
        return pid;
...
801049db:	e8 0b 05 00 00       	call   80104eeb <release>
      return -1;
...
80104a16:	e8 6e 04 00 00       	call   80104e89 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104a40:	e8 91 32 00 00       	call   80107cd6 <switchuvm>
      p->state = RUNNING;
...
80104a69:	e8 00 09 00 00       	call   8010536e <swtch>
      switchkvm();
80104a6e:	e8 46 32 00 00       	call   80107cb9 <switchkvm>
...
80104a92:	e8 54 04 00 00       	call   80104eeb <release>
...
80104aa9:	e8 05 05 00 00       	call   80104fb3 <holding>
80104aae:	85 c0                	test   %eax,%eax
80104ab0:	75 0c                	jne    80104abe <sched+0x22>
    panic("sched ptable.lock");
80104ab2:	c7 04 24 d5 87 10 80 	movl   $0x801087d5,(%esp)
...
80104acd:	74 0c                	je     80104adb <sched+0x3f>
    panic("sched locks");
80104acf:	c7 04 24 e7 87 10 80 	movl   $0x801087e7,(%esp)
...
80104ae7:	75 0c                	jne    80104af5 <sched+0x59>
    panic("sched running");
80104ae9:	c7 04 24 f3 87 10 80 	movl   $0x801087f3,(%esp)
...
80104b03:	c7 04 24 01 88 10 80 	movl   $0x80108801,(%esp)
...
80104b38:	e8 31 08 00 00       	call   8010536e <swtch>
  cpu->intena = intena;
...
80104b5b:	e8 29 03 00 00       	call   80104e89 <acquire>
  proc->state = RUNNABLE;
...
80104b79:	e8 6d 03 00 00       	call   80104eeb <release>
}
80104b7e:	c9                   	leave  
80104b7f:	c3                   	ret    
...
80104b8d:	e8 59 03 00 00       	call   80104eeb <release>

  if (first) {
80104b92:	a1 08 b0 10 80       	mov    0x8010b008,%eax
...
80104b99:	74 22                	je     80104bbd <forkret+0x3d>
    ...
    // be run from main().
    first = 0;
80104b9b:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104ba2:	00 00 00 
    iinit(ROOTDEV);
...
80104bcd:	75 0c                	jne    80104bdb <sleep+0x1c>
    panic("sleep");
80104bcf:	c7 04 24 15 88 10 80 	movl   $0x80108815,(%esp)
...
80104be1:	c7 04 24 1b 88 10 80 	movl   $0x8010881b,(%esp)
...
80104bfd:	e8 87 02 00 00       	call   80104e89 <acquire>
    release(lk);
80104c02:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c05:	89 04 24             	mov    %eax,(%esp)
80104c08:	e8 de 02 00 00       	call   80104eeb <release>
  }
...
80104c48:	e8 9e 02 00 00       	call   80104eeb <release>
    acquire(lk);
80104c4d:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c50:	89 04 24             	mov    %eax,(%esp)
80104c53:	e8 31 02 00 00       	call   80104e89 <acquire>
  }
}
80104c58:	c9                   	leave  
80104c59:	c3                   	ret    
...
80104ca5:	e8 df 01 00 00       	call   80104e89 <acquire>
  wakeup1(chan);
...
80104cbc:	e8 2a 02 00 00       	call   80104eeb <release>
}
80104cc1:	c9                   	leave  
80104cc2:	c3                   	ret    
...
80104cd0:	e8 b4 01 00 00       	call   80104e89 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104d0f:	e8 d7 01 00 00       	call   80104eeb <release>
      return 0;
...
80104d2f:	e8 b7 01 00 00       	call   80104eeb <release>
  return -1;
...
80104d6d:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
...
80104d7e:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104d85:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104d88:	eb 07                	jmp    80104d91 <procdump+0x56>
    else
      state = "???";
80104d8a:	c7 45 ec 2c 88 10 80 	movl   $0x8010882c,-0x14(%ebp)
...
80104dac:	c7 04 24 30 88 10 80 	movl   $0x80108830,(%esp)
...
80104dd9:	e8 5c 01 00 00       	call   80104f3a <getcallerpcs>
...
80104df2:	c7 04 24 39 88 10 80 	movl   $0x80108839,(%esp)
...
80104e11:	75 d4                	jne    80104de7 <procdump+0xac>
    ...
    cprintf("\n");
80104e13:	c7 04 24 3d 88 10 80 	movl   $0x8010883d,(%esp)
...
80104e5d:	f0 87 02             	lock xchg %eax,(%edx)
...
80104e6e:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e71:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80104e74:	8b 45 08             	mov    0x8(%ebp),%eax
80104e77:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80104e7d:	8b 45 08             	mov    0x8(%ebp),%eax
80104e80:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104e87:	5d                   	pop    %ebp
80104e88:	c3                   	ret    
...
80104e8f:	e8 49 01 00 00       	call   80104fdd <pushcli>
  if(holding(lk))
80104e94:	8b 45 08             	mov    0x8(%ebp),%eax
80104e97:	89 04 24             	mov    %eax,(%esp)
80104e9a:	e8 14 01 00 00       	call   80104fb3 <holding>
80104e9f:	85 c0                	test   %eax,%eax
80104ea1:	74 0c                	je     80104eaf <acquire+0x26>
    panic("acquire");
80104ea3:	c7 04 24 69 88 10 80 	movl   $0x80108869,(%esp)
80104eaa:	e8 8b b6 ff ff       	call   8010053a <panic>
...
80104eb3:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104eba:	00 
80104ebb:	89 04 24             	mov    %eax,(%esp)
80104ebe:	e8 8b ff ff ff       	call   80104e4e <xchg>
80104ec3:	85 c0                	test   %eax,%eax
80104ec5:	75 e9                	jne    80104eb0 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104ec7:	8b 45 08             	mov    0x8(%ebp),%eax
80104eca:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104ed1:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104ed4:	8b 45 08             	mov    0x8(%ebp),%eax
80104ed7:	83 c0 0c             	add    $0xc,%eax
80104eda:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ede:	8d 45 08             	lea    0x8(%ebp),%eax
80104ee1:	89 04 24             	mov    %eax,(%esp)
80104ee4:	e8 51 00 00 00       	call   80104f3a <getcallerpcs>
}
80104ee9:	c9                   	leave  
80104eea:	c3                   	ret    
...
80104ef7:	e8 b7 00 00 00       	call   80104fb3 <holding>
80104efc:	85 c0                	test   %eax,%eax
80104efe:	75 0c                	jne    80104f0c <release+0x21>
    panic("release");
80104f00:	c7 04 24 71 88 10 80 	movl   $0x80108871,(%esp)
80104f07:	e8 2e b6 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104f0c:	8b 45 08             	mov    0x8(%ebp),%eax
80104f0f:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
...
80104f2e:	e8 1b ff ff ff       	call   80104e4e <xchg>

  popcli();
80104f33:	e8 e9 00 00 00       	call   80105021 <popcli>
}
80104f38:	c9                   	leave  
80104f39:	c3                   	ret    

80104f3a <getcallerpcs>:
...
80104f3d:	83 ec 10             	sub    $0x10,%esp
  uint *ebp;
  int i;
  
  ebp = (uint*)v - 2;
80104f40:	8b 45 08             	mov    0x8(%ebp),%eax
80104f43:	83 e8 08             	sub    $0x8,%eax
80104f46:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104f49:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104f50:	eb 38                	jmp    80104f8a <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104f52:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104f56:	74 38                	je     80104f90 <getcallerpcs+0x56>
80104f58:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104f5f:	76 2f                	jbe    80104f90 <getcallerpcs+0x56>
80104f61:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104f65:	74 29                	je     80104f90 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104f67:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104f6a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104f71:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f74:	01 c2                	add    %eax,%edx
80104f76:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104f79:	8b 40 04             	mov    0x4(%eax),%eax
80104f7c:	89 02                	mov    %eax,(%edx)
...
80104f8e:	7e c2                	jle    80104f52 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104f90:	eb 19                	jmp    80104fab <getcallerpcs+0x71>
    pcs[i] = 0;
80104f92:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104f95:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104f9c:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f9f:	01 d0                	add    %edx,%eax
80104fa1:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104fa7:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104fab:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104faf:	7e e1                	jle    80104f92 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80104fb1:	c9                   	leave  
80104fb2:	c3                   	ret    
...
80104fbd:	74 17                	je     80104fd6 <holding+0x23>
80104fbf:	8b 45 08             	mov    0x8(%ebp),%eax
80104fc2:	8b 50 08             	mov    0x8(%eax),%edx
80104fc5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104fcb:	39 c2                	cmp    %eax,%edx
80104fcd:	75 07                	jne    80104fd6 <holding+0x23>
80104fcf:	b8 01 00 00 00       	mov    $0x1,%eax
80104fd4:	eb 05                	jmp    80104fdb <holding+0x28>
...
80104fe0:	83 ec 10             	sub    $0x10,%esp
  int eflags;
  
  eflags = readeflags();
80104fe3:	e8 4a fe ff ff       	call   80104e32 <readeflags>
80104fe8:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104feb:	e8 52 fe ff ff       	call   80104e42 <cli>
  if(cpu->ncli++ == 0)
80104ff0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104ff7:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
80104ffd:	8d 48 01             	lea    0x1(%eax),%ecx
80105000:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
80105006:	85 c0                	test   %eax,%eax
80105008:	75 15                	jne    8010501f <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
8010500a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105010:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105013:	81 e2 00 02 00 00    	and    $0x200,%edx
80105019:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010501f:	c9                   	leave  
80105020:	c3                   	ret    
...
80105024:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105027:	e8 06 fe ff ff       	call   80104e32 <readeflags>
8010502c:	25 00 02 00 00       	and    $0x200,%eax
80105031:	85 c0                	test   %eax,%eax
80105033:	74 0c                	je     80105041 <popcli+0x20>
    panic("popcli - interruptible");
80105035:	c7 04 24 79 88 10 80 	movl   $0x80108879,(%esp)
8010503c:	e8 f9 b4 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80105041:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105047:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010504d:	83 ea 01             	sub    $0x1,%edx
80105050:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105056:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010505c:	85 c0                	test   %eax,%eax
8010505e:	79 0c                	jns    8010506c <popcli+0x4b>
    panic("popcli");
80105060:	c7 04 24 90 88 10 80 	movl   $0x80108890,(%esp)
80105067:	e8 ce b4 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010506c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105072:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105078:	85 c0                	test   %eax,%eax
8010507a:	75 15                	jne    80105091 <popcli+0x70>
8010507c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105082:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105088:	85 c0                	test   %eax,%eax
8010508a:	74 05                	je     80105091 <popcli+0x70>
    sti();
8010508c:	e8 b7 fd ff ff       	call   80104e48 <sti>
}
80105091:	c9                   	leave  
80105092:	c3                   	ret    
...
8010509b:	8b 55 10             	mov    0x10(%ebp),%edx
8010509e:	8b 45 0c             	mov    0xc(%ebp),%eax
801050a1:	89 cb                	mov    %ecx,%ebx
801050a3:	89 df                	mov    %ebx,%edi
801050a5:	89 d1                	mov    %edx,%ecx
801050a7:	fc                   	cld    
801050a8:	f3 aa                	rep stos %al,%es:(%edi)
801050aa:	89 ca                	mov    %ecx,%edx
801050ac:	89 fb                	mov    %edi,%ebx
801050ae:	89 5d 08             	mov    %ebx,0x8(%ebp)
801050b1:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
801050bd:	8b 4d 08             	mov    0x8(%ebp),%ecx
801050c0:	8b 55 10             	mov    0x10(%ebp),%edx
801050c3:	8b 45 0c             	mov    0xc(%ebp),%eax
801050c6:	89 cb                	mov    %ecx,%ebx
801050c8:	89 df                	mov    %ebx,%edi
801050ca:	89 d1                	mov    %edx,%ecx
801050cc:	fc                   	cld    
801050cd:	f3 ab                	rep stos %eax,%es:(%edi)
801050cf:	89 ca                	mov    %ecx,%edx
801050d1:	89 fb                	mov    %edi,%ebx
801050d3:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801050eb:	75 49                	jne    80105136 <memset+0x59>
801050ed:	8b 45 10             	mov    0x10(%ebp),%eax
801050f0:	83 e0 03             	and    $0x3,%eax
801050f3:	85 c0                	test   %eax,%eax
801050f5:	75 3f                	jne    80105136 <memset+0x59>
    c &= 0xFF;
801050f7:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801050fe:	8b 45 10             	mov    0x10(%ebp),%eax
80105101:	c1 e8 02             	shr    $0x2,%eax
80105104:	89 c2                	mov    %eax,%edx
80105106:	8b 45 0c             	mov    0xc(%ebp),%eax
80105109:	c1 e0 18             	shl    $0x18,%eax
8010510c:	89 c1                	mov    %eax,%ecx
8010510e:	8b 45 0c             	mov    0xc(%ebp),%eax
80105111:	c1 e0 10             	shl    $0x10,%eax
80105114:	09 c1                	or     %eax,%ecx
80105116:	8b 45 0c             	mov    0xc(%ebp),%eax
80105119:	c1 e0 08             	shl    $0x8,%eax
8010511c:	09 c8                	or     %ecx,%eax
8010511e:	0b 45 0c             	or     0xc(%ebp),%eax
...
8010512f:	e8 84 ff ff ff       	call   801050b8 <stosl>
80105134:	eb 19                	jmp    8010514f <memset+0x72>
  } else
    stosb(dst, c, n);
80105136:	8b 45 10             	mov    0x10(%ebp),%eax
80105139:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010514a:	e8 44 ff ff ff       	call   80105093 <stosb>
  return dst;
...
80105163:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105166:	eb 30                	jmp    80105198 <memcmp+0x44>
    if(*s1 != *s2)
80105168:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010516b:	0f b6 10             	movzbl (%eax),%edx
8010516e:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105171:	0f b6 00             	movzbl (%eax),%eax
80105174:	38 c2                	cmp    %al,%dl
80105176:	74 18                	je     80105190 <memcmp+0x3c>
      return *s1 - *s2;
80105178:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010517b:	0f b6 00             	movzbl (%eax),%eax
8010517e:	0f b6 d0             	movzbl %al,%edx
80105181:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105184:	0f b6 00             	movzbl (%eax),%eax
80105187:	0f b6 c0             	movzbl %al,%eax
8010518a:	29 c2                	sub    %eax,%edx
8010518c:	89 d0                	mov    %edx,%eax
8010518e:	eb 1a                	jmp    801051aa <memcmp+0x56>
    s1++, s2++;
80105190:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105194:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
801051a3:	75 c3                	jne    80105168 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801051bb:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801051be:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051c1:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801051c4:	73 3d                	jae    80105203 <memmove+0x57>
801051c6:	8b 45 10             	mov    0x10(%ebp),%eax
801051c9:	8b 55 fc             	mov    -0x4(%ebp),%edx
801051cc:	01 d0                	add    %edx,%eax
801051ce:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801051d1:	76 30                	jbe    80105203 <memmove+0x57>
    s += n;
801051d3:	8b 45 10             	mov    0x10(%ebp),%eax
801051d6:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801051d9:	8b 45 10             	mov    0x10(%ebp),%eax
801051dc:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801051df:	eb 13                	jmp    801051f4 <memmove+0x48>
      *--d = *--s;
801051e1:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801051e5:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
801051e9:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051ec:	0f b6 10             	movzbl (%eax),%edx
801051ef:	8b 45 f8             	mov    -0x8(%ebp),%eax
801051f2:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
801051f7:	8d 50 ff             	lea    -0x1(%eax),%edx
801051fa:	89 55 10             	mov    %edx,0x10(%ebp)
801051fd:	85 c0                	test   %eax,%eax
801051ff:	75 e0                	jne    801051e1 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105201:	eb 26                	jmp    80105229 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105203:	eb 17                	jmp    8010521c <memmove+0x70>
      *d++ = *s++;
80105205:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105208:	8d 50 01             	lea    0x1(%eax),%edx
8010520b:	89 55 f8             	mov    %edx,-0x8(%ebp)
8010520e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105211:	8d 4a 01             	lea    0x1(%edx),%ecx
80105214:	89 4d fc             	mov    %ecx,-0x4(%ebp)
...
80105227:	75 dc                	jne    80105205 <memmove+0x59>
      *d++ = *s++;
...
80105248:	e8 5f ff ff ff       	call   801051ac <memmove>
}
8010524d:	c9                   	leave  
8010524e:	c3                   	ret    
...
80105250:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105252:	eb 0c                	jmp    80105260 <strncmp+0x11>
    n--, p++, q++;
80105254:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105258:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010525c:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
80105260:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105264:	74 1a                	je     80105280 <strncmp+0x31>
80105266:	8b 45 08             	mov    0x8(%ebp),%eax
80105269:	0f b6 00             	movzbl (%eax),%eax
8010526c:	84 c0                	test   %al,%al
8010526e:	74 10                	je     80105280 <strncmp+0x31>
80105270:	8b 45 08             	mov    0x8(%ebp),%eax
80105273:	0f b6 10             	movzbl (%eax),%edx
80105276:	8b 45 0c             	mov    0xc(%ebp),%eax
80105279:	0f b6 00             	movzbl (%eax),%eax
8010527c:	38 c2                	cmp    %al,%dl
8010527e:	74 d4                	je     80105254 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80105280:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105284:	75 07                	jne    8010528d <strncmp+0x3e>
    return 0;
80105286:	b8 00 00 00 00       	mov    $0x0,%eax
8010528b:	eb 16                	jmp    801052a3 <strncmp+0x54>
...
801052b5:	8d 50 ff             	lea    -0x1(%eax),%edx
801052b8:	89 55 10             	mov    %edx,0x10(%ebp)
801052bb:	85 c0                	test   %eax,%eax
801052bd:	7e 1e                	jle    801052dd <strncpy+0x38>
801052bf:	8b 45 08             	mov    0x8(%ebp),%eax
801052c2:	8d 50 01             	lea    0x1(%eax),%edx
801052c5:	89 55 08             	mov    %edx,0x8(%ebp)
801052c8:	8b 55 0c             	mov    0xc(%ebp),%edx
801052cb:	8d 4a 01             	lea    0x1(%edx),%ecx
801052ce:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801052d1:	0f b6 12             	movzbl (%edx),%edx
801052d4:	88 10                	mov    %dl,(%eax)
801052d6:	0f b6 00             	movzbl (%eax),%eax
801052d9:	84 c0                	test   %al,%al
801052db:	75 d5                	jne    801052b2 <strncpy+0xd>
    ;
  while(n-- > 0)
801052dd:	eb 0c                	jmp    801052eb <strncpy+0x46>
    *s++ = 0;
801052df:	8b 45 08             	mov    0x8(%ebp),%eax
801052e2:	8d 50 01             	lea    0x1(%eax),%edx
801052e5:	89 55 08             	mov    %edx,0x8(%ebp)
801052e8:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
801052f6:	7f e7                	jg     801052df <strncpy+0x3a>
    *s++ = 0;
  return os;
...
8010530d:	7f 05                	jg     80105314 <safestrcpy+0x17>
    return os;
8010530f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105312:	eb 31                	jmp    80105345 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105314:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105318:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010531c:	7e 1e                	jle    8010533c <safestrcpy+0x3f>
...
8010532a:	8d 4a 01             	lea    0x1(%edx),%ecx
8010532d:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105330:	0f b6 12             	movzbl (%edx),%edx
80105333:	88 10                	mov    %dl,(%eax)
80105335:	0f b6 00             	movzbl (%eax),%eax
80105338:	84 c0                	test   %al,%al
8010533a:	75 d8                	jne    80105314 <safestrcpy+0x17>
    ;
  *s = 0;
...
8010534a:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
8010534d:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105354:	eb 04                	jmp    8010535a <strlen+0x13>
80105356:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010535a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010535d:	8b 45 08             	mov    0x8(%ebp),%eax
80105360:	01 d0                	add    %edx,%eax
80105362:	0f b6 00             	movzbl (%eax),%eax
80105365:	84 c0                	test   %al,%al
80105367:	75 ed                	jne    80105356 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
8010536e:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105372:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105379:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
8010537a:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010537c:	89 d4                	mov    %edx,%esp
...
801053ce:	77 07                	ja     801053d7 <fetchstr+0x1a>
    return -1;
801053d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053d5:	eb 46                	jmp    8010541d <fetchstr+0x60>
  *pp = (char*)addr;
...
8010540a:	eb 11                	jmp    8010541d <fetchstr+0x60>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
8010540c:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105410:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105413:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105416:	72 dc                	jb     801053f4 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010542b:	8b 40 18             	mov    0x18(%eax),%eax
8010542e:	8b 50 44             	mov    0x44(%eax),%edx
80105431:	8b 45 08             	mov    0x8(%ebp),%eax
80105434:	c1 e0 02             	shl    $0x2,%eax
80105437:	01 d0                	add    %edx,%eax
80105439:	8d 50 04             	lea    0x4(%eax),%edx
8010543c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010543f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105443:	89 14 24             	mov    %edx,(%esp)
80105446:	e8 38 ff ff ff       	call   80105383 <fetchint>
}
8010544b:	c9                   	leave  
8010544c:	c3                   	ret    
...
80105450:	83 ec 18             	sub    $0x18,%esp
  int i;
  
  if(argint(n, &i) < 0)
80105453:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105456:	89 44 24 04          	mov    %eax,0x4(%esp)
8010545a:	8b 45 08             	mov    0x8(%ebp),%eax
8010545d:	89 04 24             	mov    %eax,(%esp)
80105460:	e8 ba ff ff ff       	call   8010541f <argint>
80105465:	85 c0                	test   %eax,%eax
80105467:	79 07                	jns    80105470 <argptr+0x23>
    return -1;
80105469:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010546e:	eb 3d                	jmp    801054ad <argptr+0x60>
...
8010547f:	73 16                	jae    80105497 <argptr+0x4a>
...
80105495:	76 07                	jbe    8010549e <argptr+0x51>
    return -1;
80105497:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010549c:	eb 0f                	jmp    801054ad <argptr+0x60>
  *pp = (char*)i;
8010549e:	8b 45 fc             	mov    -0x4(%ebp),%eax
801054a1:	89 c2                	mov    %eax,%edx
...
801054ea:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
801054ed:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054f3:	8b 40 18             	mov    0x18(%eax),%eax
801054f6:	8b 40 1c             	mov    0x1c(%eax),%eax
801054f9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801054fc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105500:	7e 30                	jle    80105532 <syscall+0x4c>
80105502:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105505:	83 f8 15             	cmp    $0x15,%eax
80105508:	77 28                	ja     80105532 <syscall+0x4c>
8010550a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010550d:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105514:	85 c0                	test   %eax,%eax
80105516:	74 1a                	je     80105532 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105518:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010551e:	8b 58 18             	mov    0x18(%eax),%ebx
80105521:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105524:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010552b:	ff d0                	call   *%eax
8010552d:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105530:	eb 3d                	jmp    8010556f <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105532:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105538:	8d 48 6c             	lea    0x6c(%eax),%ecx
8010553b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105541:	8b 40 10             	mov    0x10(%eax),%eax
80105544:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105547:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010554b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010554f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105553:	c7 04 24 97 88 10 80 	movl   $0x80108897,(%esp)
8010555a:	e8 41 ae ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
...
8010556f:	83 c4 24             	add    $0x24,%esp
80105572:	5b                   	pop    %ebx
80105573:	5d                   	pop    %ebp
80105574:	c3                   	ret    
...
80105588:	e8 92 fe ff ff       	call   8010541f <argint>
8010558d:	85 c0                	test   %eax,%eax
8010558f:	79 07                	jns    80105598 <argfd+0x23>
    return -1;
80105591:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105596:	eb 50                	jmp    801055e8 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105598:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010559b:	85 c0                	test   %eax,%eax
8010559d:	78 21                	js     801055c0 <argfd+0x4b>
8010559f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055a2:	83 f8 0f             	cmp    $0xf,%eax
801055a5:	7f 19                	jg     801055c0 <argfd+0x4b>
801055a7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055ad:	8b 55 f0             	mov    -0x10(%ebp),%edx
801055b0:	83 c2 08             	add    $0x8,%edx
801055b3:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801055b7:	89 45 f4             	mov    %eax,-0xc(%ebp)
801055ba:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801055be:	75 07                	jne    801055c7 <argfd+0x52>
    return -1;
801055c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055c5:	eb 21                	jmp    801055e8 <argfd+0x73>
  if(pfd)
801055c7:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801055cb:	74 08                	je     801055d5 <argfd+0x60>
    *pfd = fd;
801055cd:	8b 55 f0             	mov    -0x10(%ebp),%edx
801055d0:	8b 45 0c             	mov    0xc(%ebp),%eax
801055d3:	89 10                	mov    %edx,(%eax)
  if(pf)
801055d5:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801055d9:	74 08                	je     801055e3 <argfd+0x6e>
    *pf = f;
801055db:	8b 45 10             	mov    0x10(%ebp),%eax
801055de:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
801055ed:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
801055f0:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801055f7:	eb 30                	jmp    80105629 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
801055f9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055ff:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105602:	83 c2 08             	add    $0x8,%edx
80105605:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105609:	85 c0                	test   %eax,%eax
8010560b:	75 18                	jne    80105625 <fdalloc+0x3b>
      proc->ofile[fd] = f;
8010560d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105613:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105616:	8d 4a 08             	lea    0x8(%edx),%ecx
80105619:	8b 55 08             	mov    0x8(%ebp),%edx
8010561c:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105620:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105623:	eb 0f                	jmp    80105634 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
80105629:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
8010562d:	7e ca                	jle    801055f9 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105639:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argfd(0, 0, &f) < 0)
8010563c:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010563f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105643:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010564a:	00 
8010564b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105652:	e8 1e ff ff ff       	call   80105575 <argfd>
80105657:	85 c0                	test   %eax,%eax
80105659:	79 07                	jns    80105662 <sys_dup+0x2c>
    return -1;
8010565b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105660:	eb 29                	jmp    8010568b <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105662:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105665:	89 04 24             	mov    %eax,(%esp)
80105668:	e8 7d ff ff ff       	call   801055ea <fdalloc>
8010566d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105670:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105674:	79 07                	jns    8010567d <sys_dup+0x47>
    return -1;
80105676:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010567b:	eb 0e                	jmp    8010568b <sys_dup+0x55>
  filedup(f);
8010567d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105680:	89 04 24             	mov    %eax,(%esp)
80105683:	e8 fe b8 ff ff       	call   80100f86 <filedup>
  return fd;
...
801056a9:	e8 c7 fe ff ff       	call   80105575 <argfd>
801056ae:	85 c0                	test   %eax,%eax
801056b0:	78 35                	js     801056e7 <sys_read+0x5a>
801056b2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056b5:	89 44 24 04          	mov    %eax,0x4(%esp)
801056b9:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801056c0:	e8 5a fd ff ff       	call   8010541f <argint>
801056c5:	85 c0                	test   %eax,%eax
801056c7:	78 1e                	js     801056e7 <sys_read+0x5a>
801056c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056cc:	89 44 24 08          	mov    %eax,0x8(%esp)
801056d0:	8d 45 ec             	lea    -0x14(%ebp),%eax
801056d3:	89 44 24 04          	mov    %eax,0x4(%esp)
801056d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801056de:	e8 6a fd ff ff       	call   8010544d <argptr>
801056e3:	85 c0                	test   %eax,%eax
801056e5:	79 07                	jns    801056ee <sys_read+0x61>
    return -1;
801056e7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056ec:	eb 19                	jmp    80105707 <sys_read+0x7a>
  return fileread(f, p, n);
801056ee:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801056f1:	8b 55 ec             	mov    -0x14(%ebp),%edx
801056f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056f7:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801056fb:	89 54 24 04          	mov    %edx,0x4(%esp)
801056ff:	89 04 24             	mov    %eax,(%esp)
80105702:	e8 ec b9 ff ff       	call   801010f3 <fileread>
}
80105707:	c9                   	leave  
80105708:	c3                   	ret    
...
8010570c:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;

  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
8010570f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105712:	89 44 24 08          	mov    %eax,0x8(%esp)
80105716:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010571d:	00 
8010571e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105725:	e8 4b fe ff ff       	call   80105575 <argfd>
8010572a:	85 c0                	test   %eax,%eax
8010572c:	78 35                	js     80105763 <sys_write+0x5a>
8010572e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105731:	89 44 24 04          	mov    %eax,0x4(%esp)
80105735:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010573c:	e8 de fc ff ff       	call   8010541f <argint>
80105741:	85 c0                	test   %eax,%eax
80105743:	78 1e                	js     80105763 <sys_write+0x5a>
80105745:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105748:	89 44 24 08          	mov    %eax,0x8(%esp)
8010574c:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010574f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105753:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010575a:	e8 ee fc ff ff       	call   8010544d <argptr>
8010575f:	85 c0                	test   %eax,%eax
80105761:	79 07                	jns    8010576a <sys_write+0x61>
    return -1;
80105763:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105768:	eb 19                	jmp    80105783 <sys_write+0x7a>
  return filewrite(f, p, n);
8010576a:	8b 4d f0             	mov    -0x10(%ebp),%ecx
8010576d:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105770:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105773:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105777:	89 54 24 04          	mov    %edx,0x4(%esp)
8010577b:	89 04 24             	mov    %eax,(%esp)
8010577e:	e8 2c ba ff ff       	call   801011af <filewrite>
}
80105783:	c9                   	leave  
80105784:	c3                   	ret    
...
801057d9:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
  
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
801057dc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801057df:	89 44 24 08          	mov    %eax,0x8(%esp)
801057e3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801057ea:	00 
801057eb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801057f2:	e8 7e fd ff ff       	call   80105575 <argfd>
801057f7:	85 c0                	test   %eax,%eax
801057f9:	78 1f                	js     8010581a <sys_fstat+0x44>
801057fb:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105802:	00 
80105803:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105806:	89 44 24 04          	mov    %eax,0x4(%esp)
8010580a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105811:	e8 37 fc ff ff       	call   8010544d <argptr>
80105816:	85 c0                	test   %eax,%eax
80105818:	79 07                	jns    80105821 <sys_fstat+0x4b>
    return -1;
8010581a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010581f:	eb 12                	jmp    80105833 <sys_fstat+0x5d>
...
8010582e:	e8 71 b8 ff ff       	call   801010a4 <filestat>
}
80105833:	c9                   	leave  
80105834:	c3                   	ret    
...
80105838:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
8010583b:	8d 45 d8             	lea    -0x28(%ebp),%eax
8010583e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105842:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105849:	e8 61 fc ff ff       	call   801054af <argstr>
8010584e:	85 c0                	test   %eax,%eax
80105850:	78 17                	js     80105869 <sys_link+0x34>
80105852:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105855:	89 44 24 04          	mov    %eax,0x4(%esp)
80105859:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105860:	e8 4a fc ff ff       	call   801054af <argstr>
80105865:	85 c0                	test   %eax,%eax
80105867:	79 0a                	jns    80105873 <sys_link+0x3e>
    return -1;
80105869:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010586e:	e9 42 01 00 00       	jmp    801059b5 <sys_link+0x180>

  begin_op();
80105873:	e8 29 dc ff ff       	call   801034a1 <begin_op>
  if((ip = namei(old)) == 0){
80105878:	8b 45 d8             	mov    -0x28(%ebp),%eax
8010587b:	89 04 24             	mov    %eax,(%esp)
8010587e:	e8 e7 cb ff ff       	call   8010246a <namei>
80105883:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105886:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010588a:	75 0f                	jne    8010589b <sys_link+0x66>
    end_op();
8010588c:	e8 94 dc ff ff       	call   80103525 <end_op>
    return -1;
80105891:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105896:	e9 1a 01 00 00       	jmp    801059b5 <sys_link+0x180>
  }

  ilock(ip);
8010589b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010589e:	89 04 24             	mov    %eax,(%esp)
801058a1:	e8 13 c0 ff ff       	call   801018b9 <ilock>
  if(ip->type == T_DIR){
801058a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058a9:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801058ad:	66 83 f8 01          	cmp    $0x1,%ax
801058b1:	75 1a                	jne    801058cd <sys_link+0x98>
    iunlockput(ip);
801058b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b6:	89 04 24             	mov    %eax,(%esp)
801058b9:	e8 85 c2 ff ff       	call   80101b43 <iunlockput>
    end_op();
801058be:	e8 62 dc ff ff       	call   80103525 <end_op>
    return -1;
801058c3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058c8:	e9 e8 00 00 00       	jmp    801059b5 <sys_link+0x180>
  }

  ip->nlink++;
801058cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058d0:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801058d4:	8d 50 01             	lea    0x1(%eax),%edx
...
801058e4:	e8 0e be ff ff       	call   801016f7 <iupdate>
  iunlock(ip);
801058e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058ec:	89 04 24             	mov    %eax,(%esp)
801058ef:	e8 19 c1 ff ff       	call   80101a0d <iunlock>

  if((dp = nameiparent(new, name)) == 0)
801058f4:	8b 45 dc             	mov    -0x24(%ebp),%eax
801058f7:	8d 55 e2             	lea    -0x1e(%ebp),%edx
801058fa:	89 54 24 04          	mov    %edx,0x4(%esp)
801058fe:	89 04 24             	mov    %eax,(%esp)
80105901:	e8 86 cb ff ff       	call   8010248c <nameiparent>
80105906:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105909:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010590d:	75 02                	jne    80105911 <sys_link+0xdc>
    goto bad;
8010590f:	eb 68                	jmp    80105979 <sys_link+0x144>
  ilock(dp);
80105911:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105914:	89 04 24             	mov    %eax,(%esp)
80105917:	e8 9d bf ff ff       	call   801018b9 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
8010591c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010591f:	8b 10                	mov    (%eax),%edx
80105921:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105924:	8b 00                	mov    (%eax),%eax
80105926:	39 c2                	cmp    %eax,%edx
80105928:	75 20                	jne    8010594a <sys_link+0x115>
8010592a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010592d:	8b 40 04             	mov    0x4(%eax),%eax
80105930:	89 44 24 08          	mov    %eax,0x8(%esp)
80105934:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105937:	89 44 24 04          	mov    %eax,0x4(%esp)
8010593b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010593e:	89 04 24             	mov    %eax,(%esp)
80105941:	e8 64 c8 ff ff       	call   801021aa <dirlink>
80105946:	85 c0                	test   %eax,%eax
80105948:	79 0d                	jns    80105957 <sys_link+0x122>
    iunlockput(dp);
8010594a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010594d:	89 04 24             	mov    %eax,(%esp)
80105950:	e8 ee c1 ff ff       	call   80101b43 <iunlockput>
    goto bad;
80105955:	eb 22                	jmp    80105979 <sys_link+0x144>
  }
  iunlockput(dp);
80105957:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010595a:	89 04 24             	mov    %eax,(%esp)
8010595d:	e8 e1 c1 ff ff       	call   80101b43 <iunlockput>
  iput(ip);
80105962:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105965:	89 04 24             	mov    %eax,(%esp)
80105968:	e8 05 c1 ff ff       	call   80101a72 <iput>

  end_op();
8010596d:	e8 b3 db ff ff       	call   80103525 <end_op>

  return 0;
80105972:	b8 00 00 00 00       	mov    $0x0,%eax
80105977:	eb 3c                	jmp    801059b5 <sys_link+0x180>

bad:
  ilock(ip);
80105979:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010597c:	89 04 24             	mov    %eax,(%esp)
8010597f:	e8 35 bf ff ff       	call   801018b9 <ilock>
  ip->nlink--;
80105984:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105987:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010598b:	8d 50 ff             	lea    -0x1(%eax),%edx
8010598e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105991:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105995:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105998:	89 04 24             	mov    %eax,(%esp)
8010599b:	e8 57 bd ff ff       	call   801016f7 <iupdate>
  iunlockput(ip);
801059a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059a3:	89 04 24             	mov    %eax,(%esp)
801059a6:	e8 98 c1 ff ff       	call   80101b43 <iunlockput>
  end_op();
801059ab:	e8 75 db ff ff       	call   80103525 <end_op>
  return -1;
...
801059bd:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
801059c4:	eb 4b                	jmp    80105a11 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801059c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059c9:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801059d0:	00 
801059d1:	89 44 24 08          	mov    %eax,0x8(%esp)
801059d5:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801059d8:	89 44 24 04          	mov    %eax,0x4(%esp)
801059dc:	8b 45 08             	mov    0x8(%ebp),%eax
801059df:	89 04 24             	mov    %eax,(%esp)
801059e2:	e8 e5 c3 ff ff       	call   80101dcc <readi>
801059e7:	83 f8 10             	cmp    $0x10,%eax
801059ea:	74 0c                	je     801059f8 <isdirempty+0x41>
      panic("isdirempty: readi");
801059ec:	c7 04 24 b3 88 10 80 	movl   $0x801088b3,(%esp)
801059f3:	e8 42 ab ff ff       	call   8010053a <panic>
    if(de.inum != 0)
801059f8:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
801059fc:	66 85 c0             	test   %ax,%ax
801059ff:	74 07                	je     80105a08 <isdirempty+0x51>
      return 0;
80105a01:	b8 00 00 00 00       	mov    $0x0,%eax
80105a06:	eb 1b                	jmp    80105a23 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105a1c:	72 a8                	jb     801059c6 <isdirempty+0xf>
  ...
  return 1;
80105a1e:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105a23:	c9                   	leave  
80105a24:	c3                   	ret    
...
80105a28:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105a2b:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105a2e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a32:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a39:	e8 71 fa ff ff       	call   801054af <argstr>
80105a3e:	85 c0                	test   %eax,%eax
80105a40:	79 0a                	jns    80105a4c <sys_unlink+0x27>
    return -1;
80105a42:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a47:	e9 af 01 00 00       	jmp    80105bfb <sys_unlink+0x1d6>

  begin_op();
80105a4c:	e8 50 da ff ff       	call   801034a1 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105a51:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105a54:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105a57:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a5b:	89 04 24             	mov    %eax,(%esp)
80105a5e:	e8 29 ca ff ff       	call   8010248c <nameiparent>
80105a63:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a66:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a6a:	75 0f                	jne    80105a7b <sys_unlink+0x56>
    end_op();
80105a6c:	e8 b4 da ff ff       	call   80103525 <end_op>
    return -1;
80105a71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a76:	e9 80 01 00 00       	jmp    80105bfb <sys_unlink+0x1d6>
  }

  ilock(dp);
80105a7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a7e:	89 04 24             	mov    %eax,(%esp)
80105a81:	e8 33 be ff ff       	call   801018b9 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105a86:	c7 44 24 04 c5 88 10 	movl   $0x801088c5,0x4(%esp)
80105a8d:	80 
80105a8e:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a91:	89 04 24             	mov    %eax,(%esp)
80105a94:	e8 26 c6 ff ff       	call   801020bf <namecmp>
80105a99:	85 c0                	test   %eax,%eax
80105a9b:	0f 84 45 01 00 00    	je     80105be6 <sys_unlink+0x1c1>
80105aa1:	c7 44 24 04 c7 88 10 	movl   $0x801088c7,0x4(%esp)
80105aa8:	80 
80105aa9:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105aac:	89 04 24             	mov    %eax,(%esp)
80105aaf:	e8 0b c6 ff ff       	call   801020bf <namecmp>
80105ab4:	85 c0                	test   %eax,%eax
80105ab6:	0f 84 2a 01 00 00    	je     80105be6 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105abc:	8d 45 c8             	lea    -0x38(%ebp),%eax
...
80105ad0:	e8 0c c6 ff ff       	call   801020e1 <dirlookup>
80105ad5:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ad8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105adc:	75 05                	jne    80105ae3 <sys_unlink+0xbe>
    goto bad;
80105ade:	e9 03 01 00 00       	jmp    80105be6 <sys_unlink+0x1c1>
  ilock(ip);
80105ae3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ae6:	89 04 24             	mov    %eax,(%esp)
80105ae9:	e8 cb bd ff ff       	call   801018b9 <ilock>

  if(ip->nlink < 1)
80105aee:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105af1:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105af5:	66 85 c0             	test   %ax,%ax
80105af8:	7f 0c                	jg     80105b06 <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105afa:	c7 04 24 ca 88 10 80 	movl   $0x801088ca,(%esp)
80105b01:	e8 34 aa ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105b06:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b09:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b0d:	66 83 f8 01          	cmp    $0x1,%ax
80105b11:	75 1f                	jne    80105b32 <sys_unlink+0x10d>
80105b13:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b16:	89 04 24             	mov    %eax,(%esp)
80105b19:	e8 99 fe ff ff       	call   801059b7 <isdirempty>
80105b1e:	85 c0                	test   %eax,%eax
80105b20:	75 10                	jne    80105b32 <sys_unlink+0x10d>
    iunlockput(ip);
80105b22:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b25:	89 04 24             	mov    %eax,(%esp)
80105b28:	e8 16 c0 ff ff       	call   80101b43 <iunlockput>
    goto bad;
80105b2d:	e9 b4 00 00 00       	jmp    80105be6 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105b32:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105b39:	00 
80105b3a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b41:	00 
80105b42:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b45:	89 04 24             	mov    %eax,(%esp)
80105b48:	e8 90 f5 ff ff       	call   801050dd <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b4d:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105b50:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105b57:	00 
80105b58:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b5c:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b5f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b66:	89 04 24             	mov    %eax,(%esp)
80105b69:	e8 c2 c3 ff ff       	call   80101f30 <writei>
80105b6e:	83 f8 10             	cmp    $0x10,%eax
80105b71:	74 0c                	je     80105b7f <sys_unlink+0x15a>
    panic("unlink: writei");
80105b73:	c7 04 24 dc 88 10 80 	movl   $0x801088dc,(%esp)
80105b7a:	e8 bb a9 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105b7f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b82:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b86:	66 83 f8 01          	cmp    $0x1,%ax
80105b8a:	75 1c                	jne    80105ba8 <sys_unlink+0x183>
    dp->nlink--;
80105b8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b8f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80105ba3:	e8 4f bb ff ff       	call   801016f7 <iupdate>
  }
  iunlockput(dp);
80105ba8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bab:	89 04 24             	mov    %eax,(%esp)
80105bae:	e8 90 bf ff ff       	call   80101b43 <iunlockput>

  ip->nlink--;
80105bb3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bb6:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105bba:	8d 50 ff             	lea    -0x1(%eax),%edx
80105bbd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bc0:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105bc4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bc7:	89 04 24             	mov    %eax,(%esp)
80105bca:	e8 28 bb ff ff       	call   801016f7 <iupdate>
  iunlockput(ip);
80105bcf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bd2:	89 04 24             	mov    %eax,(%esp)
80105bd5:	e8 69 bf ff ff       	call   80101b43 <iunlockput>

  end_op();
80105bda:	e8 46 d9 ff ff       	call   80103525 <end_op>

  return 0;
80105bdf:	b8 00 00 00 00       	mov    $0x0,%eax
80105be4:	eb 15                	jmp    80105bfb <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105be6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105be9:	89 04 24             	mov    %eax,(%esp)
80105bec:	e8 52 bf ff ff       	call   80101b43 <iunlockput>
  end_op();
80105bf1:	e8 2f d9 ff ff       	call   80103525 <end_op>
  return -1;
...
80105c00:	83 ec 48             	sub    $0x48,%esp
80105c03:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105c06:	8b 55 10             	mov    0x10(%ebp),%edx
80105c09:	8b 45 14             	mov    0x14(%ebp),%eax
80105c0c:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105c10:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105c14:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105c18:	8d 45 de             	lea    -0x22(%ebp),%eax
80105c1b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c1f:	8b 45 08             	mov    0x8(%ebp),%eax
80105c22:	89 04 24             	mov    %eax,(%esp)
80105c25:	e8 62 c8 ff ff       	call   8010248c <nameiparent>
80105c2a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c2d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c31:	75 0a                	jne    80105c3d <create+0x40>
    return 0;
80105c33:	b8 00 00 00 00       	mov    $0x0,%eax
80105c38:	e9 7e 01 00 00       	jmp    80105dbb <create+0x1be>
  ilock(dp);
80105c3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c40:	89 04 24             	mov    %eax,(%esp)
80105c43:	e8 71 bc ff ff       	call   801018b9 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105c48:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105c4b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c4f:	8d 45 de             	lea    -0x22(%ebp),%eax
80105c52:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c56:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c59:	89 04 24             	mov    %eax,(%esp)
80105c5c:	e8 80 c4 ff ff       	call   801020e1 <dirlookup>
80105c61:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c64:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c68:	74 47                	je     80105cb1 <create+0xb4>
    iunlockput(dp);
80105c6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c6d:	89 04 24             	mov    %eax,(%esp)
80105c70:	e8 ce be ff ff       	call   80101b43 <iunlockput>
    ilock(ip);
80105c75:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c78:	89 04 24             	mov    %eax,(%esp)
80105c7b:	e8 39 bc ff ff       	call   801018b9 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105c80:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105c85:	75 15                	jne    80105c9c <create+0x9f>
80105c87:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c8a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105c8e:	66 83 f8 02          	cmp    $0x2,%ax
80105c92:	75 08                	jne    80105c9c <create+0x9f>
      return ip;
80105c94:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c97:	e9 1f 01 00 00       	jmp    80105dbb <create+0x1be>
    iunlockput(ip);
80105c9c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c9f:	89 04 24             	mov    %eax,(%esp)
80105ca2:	e8 9c be ff ff       	call   80101b43 <iunlockput>
    return 0;
80105ca7:	b8 00 00 00 00       	mov    $0x0,%eax
80105cac:	e9 0a 01 00 00       	jmp    80105dbb <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105cb1:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
80105cc1:	e8 5c b9 ff ff       	call   80101622 <ialloc>
80105cc6:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105cc9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ccd:	75 0c                	jne    80105cdb <create+0xde>
    panic("create: ialloc");
80105ccf:	c7 04 24 eb 88 10 80 	movl   $0x801088eb,(%esp)
80105cd6:	e8 5f a8 ff ff       	call   8010053a <panic>

  ilock(ip);
80105cdb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cde:	89 04 24             	mov    %eax,(%esp)
80105ce1:	e8 d3 bb ff ff       	call   801018b9 <ilock>
  ip->major = major;
80105ce6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ce9:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105ced:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105cf1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cf4:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105cf8:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105cfc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cff:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105d05:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d08:	89 04 24             	mov    %eax,(%esp)
80105d0b:	e8 e7 b9 ff ff       	call   801016f7 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105d10:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105d15:	75 6a                	jne    80105d81 <create+0x184>
    dp->nlink++;  // for ".."
80105d17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d1a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105d1e:	8d 50 01             	lea    0x1(%eax),%edx
80105d21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d24:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105d28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d2b:	89 04 24             	mov    %eax,(%esp)
80105d2e:	e8 c4 b9 ff ff       	call   801016f7 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105d33:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d36:	8b 40 04             	mov    0x4(%eax),%eax
80105d39:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d3d:	c7 44 24 04 c5 88 10 	movl   $0x801088c5,0x4(%esp)
80105d44:	80 
80105d45:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d48:	89 04 24             	mov    %eax,(%esp)
80105d4b:	e8 5a c4 ff ff       	call   801021aa <dirlink>
80105d50:	85 c0                	test   %eax,%eax
80105d52:	78 21                	js     80105d75 <create+0x178>
80105d54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d57:	8b 40 04             	mov    0x4(%eax),%eax
80105d5a:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d5e:	c7 44 24 04 c7 88 10 	movl   $0x801088c7,0x4(%esp)
80105d65:	80 
80105d66:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d69:	89 04 24             	mov    %eax,(%esp)
80105d6c:	e8 39 c4 ff ff       	call   801021aa <dirlink>
80105d71:	85 c0                	test   %eax,%eax
80105d73:	79 0c                	jns    80105d81 <create+0x184>
      panic("create dots");
80105d75:	c7 04 24 fa 88 10 80 	movl   $0x801088fa,(%esp)
80105d7c:	e8 b9 a7 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105d81:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d84:	8b 40 04             	mov    0x4(%eax),%eax
80105d87:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d8b:	8d 45 de             	lea    -0x22(%ebp),%eax
80105d8e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d92:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d95:	89 04 24             	mov    %eax,(%esp)
80105d98:	e8 0d c4 ff ff       	call   801021aa <dirlink>
80105d9d:	85 c0                	test   %eax,%eax
80105d9f:	79 0c                	jns    80105dad <create+0x1b0>
    panic("create: dirlink");
80105da1:	c7 04 24 06 89 10 80 	movl   $0x80108906,(%esp)
80105da8:	e8 8d a7 ff ff       	call   8010053a <panic>

  iunlockput(dp);
80105dad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105db0:	89 04 24             	mov    %eax,(%esp)
80105db3:	e8 8b bd ff ff       	call   80101b43 <iunlockput>
...
80105dc3:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105dc6:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dca:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105dd1:	e8 d9 f6 ff ff       	call   801054af <argstr>
80105dd6:	85 c0                	test   %eax,%eax
80105dd8:	78 17                	js     80105df1 <sys_open+0x34>
80105dda:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105ddd:	89 44 24 04          	mov    %eax,0x4(%esp)
80105de1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105de8:	e8 32 f6 ff ff       	call   8010541f <argint>
80105ded:	85 c0                	test   %eax,%eax
80105def:	79 0a                	jns    80105dfb <sys_open+0x3e>
    return -1;
80105df1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105df6:	e9 5c 01 00 00       	jmp    80105f57 <sys_open+0x19a>

  begin_op();
80105dfb:	e8 a1 d6 ff ff       	call   801034a1 <begin_op>

  if(omode & O_CREATE){
80105e00:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e03:	25 00 02 00 00       	and    $0x200,%eax
80105e08:	85 c0                	test   %eax,%eax
80105e0a:	74 3b                	je     80105e47 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80105e0c:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e0f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105e16:	00 
80105e17:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105e1e:	00 
80105e1f:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105e26:	00 
80105e27:	89 04 24             	mov    %eax,(%esp)
80105e2a:	e8 ce fd ff ff       	call   80105bfd <create>
80105e2f:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80105e32:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e36:	75 6b                	jne    80105ea3 <sys_open+0xe6>
      end_op();
80105e38:	e8 e8 d6 ff ff       	call   80103525 <end_op>
      return -1;
80105e3d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e42:	e9 10 01 00 00       	jmp    80105f57 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80105e47:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e4a:	89 04 24             	mov    %eax,(%esp)
80105e4d:	e8 18 c6 ff ff       	call   8010246a <namei>
80105e52:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e55:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e59:	75 0f                	jne    80105e6a <sys_open+0xad>
      end_op();
80105e5b:	e8 c5 d6 ff ff       	call   80103525 <end_op>
      return -1;
80105e60:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e65:	e9 ed 00 00 00       	jmp    80105f57 <sys_open+0x19a>
    }
    ilock(ip);
80105e6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e6d:	89 04 24             	mov    %eax,(%esp)
80105e70:	e8 44 ba ff ff       	call   801018b9 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105e75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e78:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e7c:	66 83 f8 01          	cmp    $0x1,%ax
80105e80:	75 21                	jne    80105ea3 <sys_open+0xe6>
80105e82:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e85:	85 c0                	test   %eax,%eax
80105e87:	74 1a                	je     80105ea3 <sys_open+0xe6>
      iunlockput(ip);
80105e89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e8c:	89 04 24             	mov    %eax,(%esp)
80105e8f:	e8 af bc ff ff       	call   80101b43 <iunlockput>
      end_op();
80105e94:	e8 8c d6 ff ff       	call   80103525 <end_op>
      return -1;
80105e99:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e9e:	e9 b4 00 00 00       	jmp    80105f57 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105ea3:	e8 7e b0 ff ff       	call   80100f26 <filealloc>
80105ea8:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105eab:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105eaf:	74 14                	je     80105ec5 <sys_open+0x108>
80105eb1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eb4:	89 04 24             	mov    %eax,(%esp)
80105eb7:	e8 2e f7 ff ff       	call   801055ea <fdalloc>
80105ebc:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105ebf:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105ec3:	79 28                	jns    80105eed <sys_open+0x130>
    if(f)
80105ec5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ec9:	74 0b                	je     80105ed6 <sys_open+0x119>
      fileclose(f);
80105ecb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ece:	89 04 24             	mov    %eax,(%esp)
80105ed1:	e8 f8 b0 ff ff       	call   80100fce <fileclose>
    iunlockput(ip);
80105ed6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ed9:	89 04 24             	mov    %eax,(%esp)
80105edc:	e8 62 bc ff ff       	call   80101b43 <iunlockput>
    end_op();
80105ee1:	e8 3f d6 ff ff       	call   80103525 <end_op>
    return -1;
80105ee6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eeb:	eb 6a                	jmp    80105f57 <sys_open+0x19a>
  }
  iunlock(ip);
80105eed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ef0:	89 04 24             	mov    %eax,(%esp)
80105ef3:	e8 15 bb ff ff       	call   80101a0d <iunlock>
  end_op();
80105ef8:	e8 28 d6 ff ff       	call   80103525 <end_op>

  f->type = FD_INODE;
80105efd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f00:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105f06:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f09:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f0c:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105f0f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f12:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105f19:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f1c:	83 e0 01             	and    $0x1,%eax
80105f1f:	85 c0                	test   %eax,%eax
80105f21:	0f 94 c0             	sete   %al
...
80105f34:	75 0a                	jne    80105f40 <sys_open+0x183>
80105f36:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f39:	83 e0 02             	and    $0x2,%eax
80105f3c:	85 c0                	test   %eax,%eax
80105f3e:	74 07                	je     80105f47 <sys_open+0x18a>
80105f40:	b8 01 00 00 00       	mov    $0x1,%eax
80105f45:	eb 05                	jmp    80105f4c <sys_open+0x18f>
...
80105f5c:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105f5f:	e8 3d d5 ff ff       	call   801034a1 <begin_op>
...
80105f72:	e8 38 f5 ff ff       	call   801054af <argstr>
...
80105fb9:	e8 85 bb ff ff       	call   80101b43 <iunlockput>
  end_op();
80105fbe:	e8 62 d5 ff ff       	call   80103525 <end_op>
  return 0;
...
80105fff:	e8 1b f4 ff ff       	call   8010541f <argint>
  char *path;
  int len;
  int major, minor;
...
80106016:	e8 04 f4 ff ff       	call   8010541f <argint>
  int len;
  int major, minor;
...
80106061:	e8 dd ba ff ff       	call   80101b43 <iunlockput>
  end_op();
80106066:	e8 ba d4 ff ff       	call   80103525 <end_op>
  return 0;
...
801060ba:	e8 fa b7 ff ff       	call   801018b9 <ilock>
  if(ip->type != T_DIR){
...
801060d2:	e8 6c ba ff ff       	call   80101b43 <iunlockput>
    end_op();
801060d7:	e8 49 d4 ff ff       	call   80103525 <end_op>
    return -1;
...
801060e9:	e8 1f b9 ff ff       	call   80101a0d <iunlock>
  iput(proc->cwd);
801060ee:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801060f4:	8b 40 68             	mov    0x68(%eax),%eax
801060f7:	89 04 24             	mov    %eax,(%esp)
801060fa:	e8 73 b9 ff ff       	call   80101a72 <iput>
  end_op();
801060ff:	e8 21 d4 ff ff       	call   80103525 <end_op>
  proc->cwd = ip;
...
8010612e:	e8 7c f3 ff ff       	call   801054af <argstr>
...
80106174:	e8 64 ef ff ff       	call   801050dd <memset>
  for(i=0;; i++){
...
8010618d:	e9 91 00 00 00       	jmp    80106223 <sys_exec+0x10c>
...
801061e8:	e8 02 a9 ff ff       	call   80100aef <exec>
801061ed:	eb 34                	jmp    80106223 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
801061ef:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801061f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801061f8:	c1 e2 02             	shl    $0x2,%edx
...
8010620a:	e8 ae f1 ff ff       	call   801053bd <fetchstr>
8010620f:	85 c0                	test   %eax,%eax
80106211:	79 07                	jns    8010621a <sys_exec+0x103>
      return -1;
80106213:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106218:	eb 09                	jmp    80106223 <sys_exec+0x10c>
...
8010621e:	e9 5d ff ff ff       	jmp    80106180 <sys_exec+0x69>
  return exec(path, argv);
}
80106223:	c9                   	leave  
80106224:	c3                   	ret    
...
80106241:	e8 07 f2 ff ff       	call   8010544d <argptr>
...
80106261:	e8 47 dd ff ff       	call   80103fad <pipealloc>
...
8010627e:	e8 67 f3 ff ff       	call   801055ea <fdalloc>
...
80106292:	e8 53 f3 ff ff       	call   801055ea <fdalloc>
...
801062c0:	e8 09 ad ff ff       	call   80100fce <fileclose>
    fileclose(wf);
801062c5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062c8:	89 04 24             	mov    %eax,(%esp)
801062cb:	e8 fe ac ff ff       	call   80100fce <fileclose>
    return -1;
...
801062f4:	83 ec 08             	sub    $0x8,%esp
  return fork();
801062f7:	e8 5c e3 ff ff       	call   80104658 <fork>
}
801062fc:	c9                   	leave  
801062fd:	c3                   	ret    
...
80106301:	83 ec 08             	sub    $0x8,%esp
  exit();
80106304:	e8 ca e4 ff ff       	call   801047d3 <exit>
...
80106313:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106316:	e8 da e5 ff ff       	call   801048f5 <wait>
}
8010631b:	c9                   	leave  
8010631c:	c3                   	ret    
...
8010632a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106331:	e8 e9 f0 ff ff       	call   8010541f <argint>
80106336:	85 c0                	test   %eax,%eax
80106338:	79 07                	jns    80106341 <sys_kill+0x24>
    return -1;
8010633a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010633f:	eb 0b                	jmp    8010634c <sys_kill+0x2f>
  return kill(pid);
80106341:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106344:	89 04 24             	mov    %eax,(%esp)
80106347:	e8 77 e9 ff ff       	call   80104cc3 <kill>
}
8010634c:	c9                   	leave  
8010634d:	c3                   	ret    
...
80106370:	e8 aa f0 ff ff       	call   8010541f <argint>
80106375:	85 c0                	test   %eax,%eax
80106377:	79 07                	jns    80106380 <sys_sbrk+0x24>
    return -1;
80106379:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010637e:	eb 24                	jmp    801063a4 <sys_sbrk+0x48>
  addr = proc->sz;
...
80106391:	e8 1d e2 ff ff       	call   801045b3 <growproc>
80106396:	85 c0                	test   %eax,%eax
80106398:	79 07                	jns    801063a1 <sys_sbrk+0x45>
    return -1;
8010639a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010639f:	eb 03                	jmp    801063a4 <sys_sbrk+0x48>
  return addr;
...
801063a9:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
801063ac:	8d 45 f0             	lea    -0x10(%ebp),%eax
801063af:	89 44 24 04          	mov    %eax,0x4(%esp)
801063b3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801063ba:	e8 60 f0 ff ff       	call   8010541f <argint>
801063bf:	85 c0                	test   %eax,%eax
801063c1:	79 07                	jns    801063ca <sys_sleep+0x24>
    return -1;
801063c3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063c8:	eb 6c                	jmp    80106436 <sys_sleep+0x90>
  acquire(&tickslock);
801063ca:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801063d1:	e8 b3 ea ff ff       	call   80104e89 <acquire>
  ticks0 = ticks;
801063d6:	a1 00 51 11 80       	mov    0x80115100,%eax
801063db:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801063de:	eb 34                	jmp    80106414 <sys_sleep+0x6e>
    if(proc->killed){
801063e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063e6:	8b 40 24             	mov    0x24(%eax),%eax
801063e9:	85 c0                	test   %eax,%eax
801063eb:	74 13                	je     80106400 <sys_sleep+0x5a>
      release(&tickslock);
801063ed:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801063f4:	e8 f2 ea ff ff       	call   80104eeb <release>
      return -1;
801063f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063fe:	eb 36                	jmp    80106436 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106400:	c7 44 24 04 c0 48 11 	movl   $0x801148c0,0x4(%esp)
80106407:	80 
80106408:	c7 04 24 00 51 11 80 	movl   $0x80115100,(%esp)
8010640f:	e8 ab e7 ff ff       	call   80104bbf <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106414:	a1 00 51 11 80       	mov    0x80115100,%eax
80106419:	2b 45 f4             	sub    -0xc(%ebp),%eax
8010641c:	89 c2                	mov    %eax,%edx
8010641e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106421:	39 c2                	cmp    %eax,%edx
80106423:	72 bb                	jb     801063e0 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106425:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
8010642c:	e8 ba ea ff ff       	call   80104eeb <release>
  return 0;
...
8010643b:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
8010643e:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
80106445:	e8 3f ea ff ff       	call   80104e89 <acquire>
  xticks = ticks;
8010644a:	a1 00 51 11 80       	mov    0x80115100,%eax
8010644f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106452:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
80106459:	e8 8d ea ff ff       	call   80104eeb <release>
  return xticks;
...
80106469:	8b 55 08             	mov    0x8(%ebp),%edx
8010646c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010646f:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106473:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106476:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010647a:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106487:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
8010648e:	00 
8010648f:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106496:	e8 c8 ff ff ff       	call   80106463 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
8010649b:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801064a2:	00 
801064a3:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801064aa:	e8 b4 ff ff ff       	call   80106463 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801064af:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801064b6:	00 
801064b7:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801064be:	e8 a0 ff ff ff       	call   80106463 <outb>
  picenable(IRQ_TIMER);
801064c3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801064ca:	e8 71 d9 ff ff       	call   80103e40 <picenable>
}
801064cf:	c9                   	leave  
801064d0:	c3                   	ret    
...
801064de:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801064e0:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801064e4:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801064e6:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801064e8:	54                   	push   %esp
  call trap
801064e9:	e8 d8 01 00 00       	call   801066c6 <trap>
  addl $4, %esp
...
801064ff:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106502:	8b 45 0c             	mov    0xc(%ebp),%eax
80106505:	83 e8 01             	sub    $0x1,%eax
80106508:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010650c:	8b 45 08             	mov    0x8(%ebp),%eax
8010650f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106513:	8b 45 08             	mov    0x8(%ebp),%eax
80106516:	c1 e8 10             	shr    $0x10,%eax
80106519:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
8010651d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106520:	0f 01 18             	lidtl  (%eax)
}
80106523:	c9                   	leave  
80106524:	c3                   	ret    
...
8010652b:	0f 20 d0             	mov    %cr2,%eax
8010652e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
...
80106543:	e9 c3 00 00 00       	jmp    8010660b <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106548:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010654b:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
80106552:	89 c2                	mov    %eax,%edx
80106554:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106557:	66 89 14 c5 00 49 11 	mov    %dx,-0x7feeb700(,%eax,8)
8010655e:	80 
8010655f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106562:	66 c7 04 c5 02 49 11 	movw   $0x8,-0x7feeb6fe(,%eax,8)
80106569:	80 08 00 
8010656c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010656f:	0f b6 14 c5 04 49 11 	movzbl -0x7feeb6fc(,%eax,8),%edx
80106576:	80 
80106577:	83 e2 e0             	and    $0xffffffe0,%edx
8010657a:	88 14 c5 04 49 11 80 	mov    %dl,-0x7feeb6fc(,%eax,8)
80106581:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106584:	0f b6 14 c5 04 49 11 	movzbl -0x7feeb6fc(,%eax,8),%edx
8010658b:	80 
8010658c:	83 e2 1f             	and    $0x1f,%edx
8010658f:	88 14 c5 04 49 11 80 	mov    %dl,-0x7feeb6fc(,%eax,8)
80106596:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106599:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
801065a0:	80 
801065a1:	83 e2 f0             	and    $0xfffffff0,%edx
801065a4:	83 ca 0e             	or     $0xe,%edx
801065a7:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
801065ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065b1:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
801065b8:	80 
801065b9:	83 e2 ef             	and    $0xffffffef,%edx
801065bc:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
801065c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c6:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
801065cd:	80 
801065ce:	83 e2 9f             	and    $0xffffff9f,%edx
801065d1:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
801065d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065db:	0f b6 14 c5 05 49 11 	movzbl -0x7feeb6fb(,%eax,8),%edx
801065e2:	80 
801065e3:	83 ca 80             	or     $0xffffff80,%edx
801065e6:	88 14 c5 05 49 11 80 	mov    %dl,-0x7feeb6fb(,%eax,8)
801065ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065f0:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
801065f7:	c1 e8 10             	shr    $0x10,%eax
801065fa:	89 c2                	mov    %eax,%edx
801065fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065ff:	66 89 14 c5 06 49 11 	mov    %dx,-0x7feeb6fa(,%eax,8)
80106606:	80 
void
tvinit(void)
{
...
8010660b:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106612:	0f 8e 30 ff ff ff    	jle    80106548 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106618:	a1 98 b1 10 80       	mov    0x8010b198,%eax
8010661d:	66 a3 00 4b 11 80    	mov    %ax,0x80114b00
80106623:	66 c7 05 02 4b 11 80 	movw   $0x8,0x80114b02
8010662a:	08 00 
8010662c:	0f b6 05 04 4b 11 80 	movzbl 0x80114b04,%eax
80106633:	83 e0 e0             	and    $0xffffffe0,%eax
80106636:	a2 04 4b 11 80       	mov    %al,0x80114b04
8010663b:	0f b6 05 04 4b 11 80 	movzbl 0x80114b04,%eax
80106642:	83 e0 1f             	and    $0x1f,%eax
80106645:	a2 04 4b 11 80       	mov    %al,0x80114b04
8010664a:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
80106651:	83 c8 0f             	or     $0xf,%eax
80106654:	a2 05 4b 11 80       	mov    %al,0x80114b05
80106659:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
80106660:	83 e0 ef             	and    $0xffffffef,%eax
80106663:	a2 05 4b 11 80       	mov    %al,0x80114b05
80106668:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
8010666f:	83 c8 60             	or     $0x60,%eax
80106672:	a2 05 4b 11 80       	mov    %al,0x80114b05
80106677:	0f b6 05 05 4b 11 80 	movzbl 0x80114b05,%eax
8010667e:	83 c8 80             	or     $0xffffff80,%eax
80106681:	a2 05 4b 11 80       	mov    %al,0x80114b05
80106686:	a1 98 b1 10 80       	mov    0x8010b198,%eax
8010668b:	c1 e8 10             	shr    $0x10,%eax
8010668e:	66 a3 06 4b 11 80    	mov    %ax,0x80114b06
  
  initlock(&tickslock, "time");
80106694:	c7 44 24 04 18 89 10 	movl   $0x80108918,0x4(%esp)
8010669b:	80 
8010669c:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
801066a3:	e8 c0 e7 ff ff       	call   80104e68 <initlock>
}
801066a8:	c9                   	leave  
801066a9:	c3                   	ret    
...
801066ad:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801066b0:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801066b7:	00 
801066b8:	c7 04 24 00 49 11 80 	movl   $0x80114900,(%esp)
801066bf:	e8 38 fe ff ff       	call   801064fc <lidt>
}
801066c4:	c9                   	leave  
801066c5:	c3                   	ret    
...
801066cc:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801066cf:	8b 45 08             	mov    0x8(%ebp),%eax
801066d2:	8b 40 30             	mov    0x30(%eax),%eax
801066d5:	83 f8 40             	cmp    $0x40,%eax
801066d8:	75 3f                	jne    80106719 <trap+0x53>
    if(proc->killed)
801066da:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066e0:	8b 40 24             	mov    0x24(%eax),%eax
801066e3:	85 c0                	test   %eax,%eax
801066e5:	74 05                	je     801066ec <trap+0x26>
      exit();
801066e7:	e8 e7 e0 ff ff       	call   801047d3 <exit>
    proc->tf = tf;
801066ec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066f2:	8b 55 08             	mov    0x8(%ebp),%edx
801066f5:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801066f8:	e8 e9 ed ff ff       	call   801054e6 <syscall>
    if(proc->killed)
801066fd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106703:	8b 40 24             	mov    0x24(%eax),%eax
80106706:	85 c0                	test   %eax,%eax
80106708:	74 0a                	je     80106714 <trap+0x4e>
      exit();
8010670a:	e8 c4 e0 ff ff       	call   801047d3 <exit>
    return;
8010670f:	e9 2d 02 00 00       	jmp    80106941 <trap+0x27b>
80106714:	e9 28 02 00 00       	jmp    80106941 <trap+0x27b>
  }
...
80106725:	0f 87 bc 00 00 00    	ja     801067e7 <trap+0x121>
8010672b:	8b 04 85 c0 89 10 80 	mov    -0x7fef7640(,%eax,4),%eax
...
8010673f:	75 31                	jne    80106772 <trap+0xac>
      acquire(&tickslock);
80106741:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
80106748:	e8 3c e7 ff ff       	call   80104e89 <acquire>
      ticks++;
8010674d:	a1 00 51 11 80       	mov    0x80115100,%eax
80106752:	83 c0 01             	add    $0x1,%eax
80106755:	a3 00 51 11 80       	mov    %eax,0x80115100
      wakeup(&ticks);
8010675a:	c7 04 24 00 51 11 80 	movl   $0x80115100,(%esp)
80106761:	e8 32 e5 ff ff       	call   80104c98 <wakeup>
      release(&tickslock);
80106766:	c7 04 24 c0 48 11 80 	movl   $0x801148c0,(%esp)
8010676d:	e8 79 e7 ff ff       	call   80104eeb <release>
    }
    lapiceoi();
80106772:	e8 f4 c7 ff ff       	call   80102f6b <lapiceoi>
    break;
80106777:	e9 41 01 00 00       	jmp    801068bd <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
8010677c:	e8 f8 bf ff ff       	call   80102779 <ideintr>
    lapiceoi();
80106781:	e8 e5 c7 ff ff       	call   80102f6b <lapiceoi>
    break;
80106786:	e9 32 01 00 00       	jmp    801068bd <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010678b:	e8 aa c5 ff ff       	call   80102d3a <kbdintr>
    lapiceoi();
80106790:	e8 d6 c7 ff ff       	call   80102f6b <lapiceoi>
    break;
80106795:	e9 23 01 00 00       	jmp    801068bd <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010679a:	e8 97 03 00 00       	call   80106b36 <uartintr>
    lapiceoi();
8010679f:	e8 c7 c7 ff ff       	call   80102f6b <lapiceoi>
    break;
801067a4:	e9 14 01 00 00       	jmp    801068bd <trap+0x1f7>
  case T_IRQ0 + 7:
...
801067d1:	c7 04 24 20 89 10 80 	movl   $0x80108920,(%esp)
801067d8:	e8 c3 9b ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801067dd:	e8 89 c7 ff ff       	call   80102f6b <lapiceoi>
    break;
801067e2:	e9 d6 00 00 00       	jmp    801068bd <trap+0x1f7>
...
801067ef:	74 11                	je     80106802 <trap+0x13c>
...
80106800:	75 46                	jne    80106848 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106802:	e8 1e fd ff ff       	call   80106525 <rcr2>
...
80106830:	c7 04 24 44 89 10 80 	movl   $0x80108944,(%esp)
80106837:	e8 64 9b ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
8010683c:	c7 04 24 76 89 10 80 	movl   $0x80108976,(%esp)
80106843:	e8 f2 9c ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106848:	e8 d8 fc ff ff       	call   80106525 <rcr2>
...
80106896:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106899:	89 74 24 08          	mov    %esi,0x8(%esp)
8010689d:	89 44 24 04          	mov    %eax,0x4(%esp)
801068a1:	c7 04 24 7c 89 10 80 	movl   $0x8010897c,(%esp)
801068a8:	e8 f3 9a ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
...
801068ba:	eb 01                	jmp    801068bd <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801068e4:	75 05                	jne    801068eb <trap+0x225>
    exit();
801068e6:	e8 e8 de ff ff       	call   801047d3 <exit>
...
801068f3:	74 1e                	je     80106913 <trap+0x24d>
801068f5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068fb:	8b 40 0c             	mov    0xc(%eax),%eax
801068fe:	83 f8 04             	cmp    $0x4,%eax
80106901:	75 10                	jne    80106913 <trap+0x24d>
80106903:	8b 45 08             	mov    0x8(%ebp),%eax
80106906:	8b 40 30             	mov    0x30(%eax),%eax
80106909:	83 f8 20             	cmp    $0x20,%eax
8010690c:	75 05                	jne    80106913 <trap+0x24d>
    yield();
8010690e:	e8 3b e2 ff ff       	call   80104b4e <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106913:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106919:	85 c0                	test   %eax,%eax
8010691b:	74 24                	je     80106941 <trap+0x27b>
8010691d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106923:	8b 40 24             	mov    0x24(%eax),%eax
80106926:	85 c0                	test   %eax,%eax
80106928:	74 17                	je     80106941 <trap+0x27b>
8010692a:	8b 45 08             	mov    0x8(%ebp),%eax
8010692d:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106931:	0f b7 c0             	movzwl %ax,%eax
80106934:	83 e0 03             	and    $0x3,%eax
80106937:	83 f8 03             	cmp    $0x3,%eax
8010693a:	75 05                	jne    80106941 <trap+0x27b>
    exit();
8010693c:	e8 92 de ff ff       	call   801047d3 <exit>
}
80106941:	83 c4 3c             	add    $0x3c,%esp
80106944:	5b                   	pop    %ebx
80106945:	5e                   	pop    %esi
80106946:	5f                   	pop    %edi
80106947:	5d                   	pop    %ebp
...
8010694c:	83 ec 14             	sub    $0x14,%esp
8010694f:	8b 45 08             	mov    0x8(%ebp),%eax
80106952:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106956:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
8010695a:	89 c2                	mov    %eax,%edx
8010695c:	ec                   	in     (%dx),%al
8010695d:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106960:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106964:	c9                   	leave  
80106965:	c3                   	ret    
...
80106972:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106976:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106979:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010697d:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106999:	e8 c8 ff ff ff       	call   80106966 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
8010699e:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801069a5:	00 
801069a6:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801069ad:	e8 b4 ff ff ff       	call   80106966 <outb>
  outb(COM1+0, 115200/9600);
801069b2:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801069b9:	00 
801069ba:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069c1:	e8 a0 ff ff ff       	call   80106966 <outb>
  outb(COM1+1, 0);
801069c6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069cd:	00 
801069ce:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801069d5:	e8 8c ff ff ff       	call   80106966 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801069da:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801069e1:	00 
801069e2:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801069e9:	e8 78 ff ff ff       	call   80106966 <outb>
  outb(COM1+4, 0);
801069ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069f5:	00 
801069f6:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
801069fd:	e8 64 ff ff ff       	call   80106966 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106a02:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106a09:	00 
80106a0a:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106a11:	e8 50 ff ff ff       	call   80106966 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106a16:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a1d:	e8 27 ff ff ff       	call   80106949 <inb>
80106a22:	3c ff                	cmp    $0xff,%al
80106a24:	75 02                	jne    80106a28 <uartinit+0xa4>
    return;
80106a26:	eb 6a                	jmp    80106a92 <uartinit+0x10e>
  uart = 1;
80106a28:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106a2f:	00 00 00 
...
80106a39:	e8 0b ff ff ff       	call   80106949 <inb>
  inb(COM1+0);
80106a3e:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a45:	e8 ff fe ff ff       	call   80106949 <inb>
  picenable(IRQ_COM1);
80106a4a:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106a51:	e8 ea d3 ff ff       	call   80103e40 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106a56:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a5d:	00 
80106a5e:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106a65:	e8 8e bf ff ff       	call   801029f8 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106a6a:	c7 45 f4 40 8a 10 80 	movl   $0x80108a40,-0xc(%ebp)
80106a71:	eb 15                	jmp    80106a88 <uartinit+0x104>
    uartputc(*p);
80106a73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a76:	0f b6 00             	movzbl (%eax),%eax
80106a79:	0f be c0             	movsbl %al,%eax
80106a7c:	89 04 24             	mov    %eax,(%esp)
80106a7f:	e8 10 00 00 00       	call   80106a94 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106a84:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106a88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a8b:	0f b6 00             	movzbl (%eax),%eax
80106a8e:	84 c0                	test   %al,%al
80106a90:	75 e1                	jne    80106a73 <uartinit+0xef>
    uartputc(*p);
}
80106a92:	c9                   	leave  
80106a93:	c3                   	ret    
...
80106a97:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106a9a:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106a9f:	85 c0                	test   %eax,%eax
80106aa1:	75 02                	jne    80106aa5 <uartputc+0x11>
    return;
80106aa3:	eb 4b                	jmp    80106af0 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106aa5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106aac:	eb 10                	jmp    80106abe <uartputc+0x2a>
    microdelay(10);
80106aae:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106ab5:	e8 d6 c4 ff ff       	call   80102f90 <microdelay>
{
  int i;
...
80106abe:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106ac2:	7f 16                	jg     80106ada <uartputc+0x46>
80106ac4:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106acb:	e8 79 fe ff ff       	call   80106949 <inb>
80106ad0:	0f b6 c0             	movzbl %al,%eax
80106ad3:	83 e0 20             	and    $0x20,%eax
80106ad6:	85 c0                	test   %eax,%eax
80106ad8:	74 d4                	je     80106aae <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106ada:	8b 45 08             	mov    0x8(%ebp),%eax
80106add:	0f b6 c0             	movzbl %al,%eax
80106ae0:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ae4:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106aeb:	e8 76 fe ff ff       	call   80106966 <outb>
}
80106af0:	c9                   	leave  
80106af1:	c3                   	ret    
...
80106af5:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106af8:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106afd:	85 c0                	test   %eax,%eax
80106aff:	75 07                	jne    80106b08 <uartgetc+0x16>
    return -1;
80106b01:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b06:	eb 2c                	jmp    80106b34 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106b08:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b0f:	e8 35 fe ff ff       	call   80106949 <inb>
80106b14:	0f b6 c0             	movzbl %al,%eax
80106b17:	83 e0 01             	and    $0x1,%eax
80106b1a:	85 c0                	test   %eax,%eax
80106b1c:	75 07                	jne    80106b25 <uartgetc+0x33>
    return -1;
80106b1e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b23:	eb 0f                	jmp    80106b34 <uartgetc+0x42>
  return inb(COM1+0);
80106b25:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b2c:	e8 18 fe ff ff       	call   80106949 <inb>
80106b31:	0f b6 c0             	movzbl %al,%eax
}
80106b34:	c9                   	leave  
80106b35:	c3                   	ret    
...
80106b39:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106b3c:	c7 04 24 f2 6a 10 80 	movl   $0x80106af2,(%esp)
80106b43:	e8 65 9c ff ff       	call   801007ad <consoleintr>
}
80106b48:	c9                   	leave  
80106b49:	c3                   	ret    
...
80106b4c:	6a 00                	push   $0x0
  jmp alltraps
80106b4e:	e9 7e f9 ff ff       	jmp    801064d1 <alltraps>
...
80106b55:	6a 01                	push   $0x1
  jmp alltraps
80106b57:	e9 75 f9 ff ff       	jmp    801064d1 <alltraps>
...
80106b5c:	6a 00                	push   $0x0
  pushl $2
80106b5e:	6a 02                	push   $0x2
  jmp alltraps
80106b60:	e9 6c f9 ff ff       	jmp    801064d1 <alltraps>
...
80106b65:	6a 00                	push   $0x0
  pushl $3
80106b67:	6a 03                	push   $0x3
  jmp alltraps
80106b69:	e9 63 f9 ff ff       	jmp    801064d1 <alltraps>
...
80106b70:	6a 04                	push   $0x4
  jmp alltraps
80106b72:	e9 5a f9 ff ff       	jmp    801064d1 <alltraps>
...
80106b77:	6a 00                	push   $0x0
  pushl $5
80106b79:	6a 05                	push   $0x5
  jmp alltraps
80106b7b:	e9 51 f9 ff ff       	jmp    801064d1 <alltraps>
...
80106b80:	6a 00                	push   $0x0
  pushl $6
80106b82:	6a 06                	push   $0x6
  jmp alltraps
80106b84:	e9 48 f9 ff ff       	jmp    801064d1 <alltraps>
...
80106b89:	6a 00                	push   $0x0
  pushl $7
80106b8b:	6a 07                	push   $0x7
  jmp alltraps
80106b8d:	e9 3f f9 ff ff       	jmp    801064d1 <alltraps>

80106b92 <vector8>:
.globl vector8
vector8:
  pushl $8
80106b92:	6a 08                	push   $0x8
  jmp alltraps
80106b94:	e9 38 f9 ff ff       	jmp    801064d1 <alltraps>
...
80106b99:	6a 00                	push   $0x0
  pushl $9
80106b9b:	6a 09                	push   $0x9
  jmp alltraps
80106b9d:	e9 2f f9 ff ff       	jmp    801064d1 <alltraps>

80106ba2 <vector10>:
.globl vector10
vector10:
  pushl $10
80106ba2:	6a 0a                	push   $0xa
  jmp alltraps
80106ba4:	e9 28 f9 ff ff       	jmp    801064d1 <alltraps>

80106ba9 <vector11>:
.globl vector11
vector11:
  pushl $11
80106ba9:	6a 0b                	push   $0xb
  jmp alltraps
...
vector12:
  pushl $12
80106bb0:	6a 0c                	push   $0xc
  jmp alltraps
80106bb2:	e9 1a f9 ff ff       	jmp    801064d1 <alltraps>

80106bb7 <vector13>:
.globl vector13
vector13:
  pushl $13
80106bb7:	6a 0d                	push   $0xd
  jmp alltraps
80106bb9:	e9 13 f9 ff ff       	jmp    801064d1 <alltraps>

80106bbe <vector14>:
.globl vector14
vector14:
  pushl $14
80106bbe:	6a 0e                	push   $0xe
  jmp alltraps
80106bc0:	e9 0c f9 ff ff       	jmp    801064d1 <alltraps>
...
80106bc5:	6a 00                	push   $0x0
  pushl $15
80106bc7:	6a 0f                	push   $0xf
  jmp alltraps
80106bc9:	e9 03 f9 ff ff       	jmp    801064d1 <alltraps>
...
80106bce:	6a 00                	push   $0x0
  pushl $16
80106bd0:	6a 10                	push   $0x10
  jmp alltraps
80106bd2:	e9 fa f8 ff ff       	jmp    801064d1 <alltraps>

80106bd7 <vector17>:
.globl vector17
vector17:
  pushl $17
80106bd7:	6a 11                	push   $0x11
  jmp alltraps
80106bd9:	e9 f3 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106bde:	6a 00                	push   $0x0
  pushl $18
80106be0:	6a 12                	push   $0x12
  jmp alltraps
80106be2:	e9 ea f8 ff ff       	jmp    801064d1 <alltraps>
...
80106be7:	6a 00                	push   $0x0
  pushl $19
80106be9:	6a 13                	push   $0x13
  jmp alltraps
80106beb:	e9 e1 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106bf0:	6a 00                	push   $0x0
  pushl $20
80106bf2:	6a 14                	push   $0x14
  jmp alltraps
80106bf4:	e9 d8 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106bf9:	6a 00                	push   $0x0
  pushl $21
80106bfb:	6a 15                	push   $0x15
  jmp alltraps
80106bfd:	e9 cf f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c02:	6a 00                	push   $0x0
  pushl $22
80106c04:	6a 16                	push   $0x16
  jmp alltraps
80106c06:	e9 c6 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c0b:	6a 00                	push   $0x0
  pushl $23
80106c0d:	6a 17                	push   $0x17
  jmp alltraps
80106c0f:	e9 bd f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c14:	6a 00                	push   $0x0
  pushl $24
80106c16:	6a 18                	push   $0x18
  jmp alltraps
80106c18:	e9 b4 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c1d:	6a 00                	push   $0x0
  pushl $25
80106c1f:	6a 19                	push   $0x19
  jmp alltraps
80106c21:	e9 ab f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c26:	6a 00                	push   $0x0
  pushl $26
80106c28:	6a 1a                	push   $0x1a
  jmp alltraps
80106c2a:	e9 a2 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c2f:	6a 00                	push   $0x0
  pushl $27
80106c31:	6a 1b                	push   $0x1b
  jmp alltraps
80106c33:	e9 99 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c38:	6a 00                	push   $0x0
  pushl $28
80106c3a:	6a 1c                	push   $0x1c
  jmp alltraps
80106c3c:	e9 90 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c41:	6a 00                	push   $0x0
  pushl $29
80106c43:	6a 1d                	push   $0x1d
  jmp alltraps
80106c45:	e9 87 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c4a:	6a 00                	push   $0x0
  pushl $30
80106c4c:	6a 1e                	push   $0x1e
  jmp alltraps
80106c4e:	e9 7e f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c53:	6a 00                	push   $0x0
  pushl $31
80106c55:	6a 1f                	push   $0x1f
  jmp alltraps
80106c57:	e9 75 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c5c:	6a 00                	push   $0x0
  pushl $32
80106c5e:	6a 20                	push   $0x20
  jmp alltraps
80106c60:	e9 6c f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c65:	6a 00                	push   $0x0
  pushl $33
80106c67:	6a 21                	push   $0x21
  jmp alltraps
80106c69:	e9 63 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c6e:	6a 00                	push   $0x0
  pushl $34
80106c70:	6a 22                	push   $0x22
  jmp alltraps
80106c72:	e9 5a f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c77:	6a 00                	push   $0x0
  pushl $35
80106c79:	6a 23                	push   $0x23
  jmp alltraps
80106c7b:	e9 51 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c80:	6a 00                	push   $0x0
  pushl $36
80106c82:	6a 24                	push   $0x24
  jmp alltraps
80106c84:	e9 48 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c89:	6a 00                	push   $0x0
  pushl $37
80106c8b:	6a 25                	push   $0x25
  jmp alltraps
80106c8d:	e9 3f f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c92:	6a 00                	push   $0x0
  pushl $38
80106c94:	6a 26                	push   $0x26
  jmp alltraps
80106c96:	e9 36 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106c9b:	6a 00                	push   $0x0
  pushl $39
80106c9d:	6a 27                	push   $0x27
  jmp alltraps
80106c9f:	e9 2d f8 ff ff       	jmp    801064d1 <alltraps>
...
80106ca4:	6a 00                	push   $0x0
  pushl $40
80106ca6:	6a 28                	push   $0x28
  jmp alltraps
80106ca8:	e9 24 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106cad:	6a 00                	push   $0x0
  pushl $41
80106caf:	6a 29                	push   $0x29
  jmp alltraps
80106cb1:	e9 1b f8 ff ff       	jmp    801064d1 <alltraps>
...
80106cb6:	6a 00                	push   $0x0
  pushl $42
80106cb8:	6a 2a                	push   $0x2a
  jmp alltraps
80106cba:	e9 12 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106cbf:	6a 00                	push   $0x0
  pushl $43
80106cc1:	6a 2b                	push   $0x2b
  jmp alltraps
80106cc3:	e9 09 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106cc8:	6a 00                	push   $0x0
  pushl $44
80106cca:	6a 2c                	push   $0x2c
  jmp alltraps
80106ccc:	e9 00 f8 ff ff       	jmp    801064d1 <alltraps>
...
80106cd1:	6a 00                	push   $0x0
  pushl $45
80106cd3:	6a 2d                	push   $0x2d
  jmp alltraps
80106cd5:	e9 f7 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106cda:	6a 00                	push   $0x0
  pushl $46
80106cdc:	6a 2e                	push   $0x2e
  jmp alltraps
80106cde:	e9 ee f7 ff ff       	jmp    801064d1 <alltraps>
...
80106ce3:	6a 00                	push   $0x0
  pushl $47
80106ce5:	6a 2f                	push   $0x2f
  jmp alltraps
80106ce7:	e9 e5 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106cec:	6a 00                	push   $0x0
  pushl $48
80106cee:	6a 30                	push   $0x30
  jmp alltraps
80106cf0:	e9 dc f7 ff ff       	jmp    801064d1 <alltraps>
...
80106cf5:	6a 00                	push   $0x0
  pushl $49
80106cf7:	6a 31                	push   $0x31
  jmp alltraps
80106cf9:	e9 d3 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106cfe:	6a 00                	push   $0x0
  pushl $50
80106d00:	6a 32                	push   $0x32
  jmp alltraps
80106d02:	e9 ca f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d07:	6a 00                	push   $0x0
  pushl $51
80106d09:	6a 33                	push   $0x33
  jmp alltraps
80106d0b:	e9 c1 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d10:	6a 00                	push   $0x0
  pushl $52
80106d12:	6a 34                	push   $0x34
  jmp alltraps
80106d14:	e9 b8 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d19:	6a 00                	push   $0x0
  pushl $53
80106d1b:	6a 35                	push   $0x35
  jmp alltraps
80106d1d:	e9 af f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d22:	6a 00                	push   $0x0
  pushl $54
80106d24:	6a 36                	push   $0x36
  jmp alltraps
80106d26:	e9 a6 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d2b:	6a 00                	push   $0x0
  pushl $55
80106d2d:	6a 37                	push   $0x37
  jmp alltraps
80106d2f:	e9 9d f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d34:	6a 00                	push   $0x0
  pushl $56
80106d36:	6a 38                	push   $0x38
  jmp alltraps
80106d38:	e9 94 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d3d:	6a 00                	push   $0x0
  pushl $57
80106d3f:	6a 39                	push   $0x39
  jmp alltraps
80106d41:	e9 8b f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d46:	6a 00                	push   $0x0
  pushl $58
80106d48:	6a 3a                	push   $0x3a
  jmp alltraps
80106d4a:	e9 82 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d4f:	6a 00                	push   $0x0
  pushl $59
80106d51:	6a 3b                	push   $0x3b
  jmp alltraps
80106d53:	e9 79 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d58:	6a 00                	push   $0x0
  pushl $60
80106d5a:	6a 3c                	push   $0x3c
  jmp alltraps
80106d5c:	e9 70 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d61:	6a 00                	push   $0x0
  pushl $61
80106d63:	6a 3d                	push   $0x3d
  jmp alltraps
80106d65:	e9 67 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d6a:	6a 00                	push   $0x0
  pushl $62
80106d6c:	6a 3e                	push   $0x3e
  jmp alltraps
80106d6e:	e9 5e f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d73:	6a 00                	push   $0x0
  pushl $63
80106d75:	6a 3f                	push   $0x3f
  jmp alltraps
80106d77:	e9 55 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d7c:	6a 00                	push   $0x0
  pushl $64
80106d7e:	6a 40                	push   $0x40
  jmp alltraps
80106d80:	e9 4c f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d85:	6a 00                	push   $0x0
  pushl $65
80106d87:	6a 41                	push   $0x41
  jmp alltraps
80106d89:	e9 43 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d8e:	6a 00                	push   $0x0
  pushl $66
80106d90:	6a 42                	push   $0x42
  jmp alltraps
80106d92:	e9 3a f7 ff ff       	jmp    801064d1 <alltraps>
...
80106d97:	6a 00                	push   $0x0
  pushl $67
80106d99:	6a 43                	push   $0x43
  jmp alltraps
80106d9b:	e9 31 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106da0:	6a 00                	push   $0x0
  pushl $68
80106da2:	6a 44                	push   $0x44
  jmp alltraps
80106da4:	e9 28 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106da9:	6a 00                	push   $0x0
  pushl $69
80106dab:	6a 45                	push   $0x45
  jmp alltraps
80106dad:	e9 1f f7 ff ff       	jmp    801064d1 <alltraps>
...
80106db2:	6a 00                	push   $0x0
  pushl $70
80106db4:	6a 46                	push   $0x46
  jmp alltraps
80106db6:	e9 16 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106dbb:	6a 00                	push   $0x0
  pushl $71
80106dbd:	6a 47                	push   $0x47
  jmp alltraps
80106dbf:	e9 0d f7 ff ff       	jmp    801064d1 <alltraps>
...
80106dc4:	6a 00                	push   $0x0
  pushl $72
80106dc6:	6a 48                	push   $0x48
  jmp alltraps
80106dc8:	e9 04 f7 ff ff       	jmp    801064d1 <alltraps>
...
80106dcd:	6a 00                	push   $0x0
  pushl $73
80106dcf:	6a 49                	push   $0x49
  jmp alltraps
80106dd1:	e9 fb f6 ff ff       	jmp    801064d1 <alltraps>
...
80106dd6:	6a 00                	push   $0x0
  pushl $74
80106dd8:	6a 4a                	push   $0x4a
  jmp alltraps
80106dda:	e9 f2 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106ddf:	6a 00                	push   $0x0
  pushl $75
80106de1:	6a 4b                	push   $0x4b
  jmp alltraps
80106de3:	e9 e9 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106de8:	6a 00                	push   $0x0
  pushl $76
80106dea:	6a 4c                	push   $0x4c
  jmp alltraps
80106dec:	e9 e0 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106df1:	6a 00                	push   $0x0
  pushl $77
80106df3:	6a 4d                	push   $0x4d
  jmp alltraps
80106df5:	e9 d7 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106dfa:	6a 00                	push   $0x0
  pushl $78
80106dfc:	6a 4e                	push   $0x4e
  jmp alltraps
80106dfe:	e9 ce f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e03:	6a 00                	push   $0x0
  pushl $79
80106e05:	6a 4f                	push   $0x4f
  jmp alltraps
80106e07:	e9 c5 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e0c:	6a 00                	push   $0x0
  pushl $80
80106e0e:	6a 50                	push   $0x50
  jmp alltraps
80106e10:	e9 bc f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e15:	6a 00                	push   $0x0
  pushl $81
80106e17:	6a 51                	push   $0x51
  jmp alltraps
80106e19:	e9 b3 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e1e:	6a 00                	push   $0x0
  pushl $82
80106e20:	6a 52                	push   $0x52
  jmp alltraps
80106e22:	e9 aa f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e27:	6a 00                	push   $0x0
  pushl $83
80106e29:	6a 53                	push   $0x53
  jmp alltraps
80106e2b:	e9 a1 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e30:	6a 00                	push   $0x0
  pushl $84
80106e32:	6a 54                	push   $0x54
  jmp alltraps
80106e34:	e9 98 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e39:	6a 00                	push   $0x0
  pushl $85
80106e3b:	6a 55                	push   $0x55
  jmp alltraps
80106e3d:	e9 8f f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e42:	6a 00                	push   $0x0
  pushl $86
80106e44:	6a 56                	push   $0x56
  jmp alltraps
80106e46:	e9 86 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e4b:	6a 00                	push   $0x0
  pushl $87
80106e4d:	6a 57                	push   $0x57
  jmp alltraps
80106e4f:	e9 7d f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e54:	6a 00                	push   $0x0
  pushl $88
80106e56:	6a 58                	push   $0x58
  jmp alltraps
80106e58:	e9 74 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e5d:	6a 00                	push   $0x0
  pushl $89
80106e5f:	6a 59                	push   $0x59
  jmp alltraps
80106e61:	e9 6b f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e66:	6a 00                	push   $0x0
  pushl $90
80106e68:	6a 5a                	push   $0x5a
  jmp alltraps
80106e6a:	e9 62 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e6f:	6a 00                	push   $0x0
  pushl $91
80106e71:	6a 5b                	push   $0x5b
  jmp alltraps
80106e73:	e9 59 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e78:	6a 00                	push   $0x0
  pushl $92
80106e7a:	6a 5c                	push   $0x5c
  jmp alltraps
80106e7c:	e9 50 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e81:	6a 00                	push   $0x0
  pushl $93
80106e83:	6a 5d                	push   $0x5d
  jmp alltraps
80106e85:	e9 47 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e8a:	6a 00                	push   $0x0
  pushl $94
80106e8c:	6a 5e                	push   $0x5e
  jmp alltraps
80106e8e:	e9 3e f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e93:	6a 00                	push   $0x0
  pushl $95
80106e95:	6a 5f                	push   $0x5f
  jmp alltraps
80106e97:	e9 35 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106e9c:	6a 00                	push   $0x0
  pushl $96
80106e9e:	6a 60                	push   $0x60
  jmp alltraps
80106ea0:	e9 2c f6 ff ff       	jmp    801064d1 <alltraps>
...
80106ea5:	6a 00                	push   $0x0
  pushl $97
80106ea7:	6a 61                	push   $0x61
  jmp alltraps
80106ea9:	e9 23 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106eae:	6a 00                	push   $0x0
  pushl $98
80106eb0:	6a 62                	push   $0x62
  jmp alltraps
80106eb2:	e9 1a f6 ff ff       	jmp    801064d1 <alltraps>
...
80106eb7:	6a 00                	push   $0x0
  pushl $99
80106eb9:	6a 63                	push   $0x63
  jmp alltraps
80106ebb:	e9 11 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106ec0:	6a 00                	push   $0x0
  pushl $100
80106ec2:	6a 64                	push   $0x64
  jmp alltraps
80106ec4:	e9 08 f6 ff ff       	jmp    801064d1 <alltraps>
...
80106ec9:	6a 00                	push   $0x0
  pushl $101
80106ecb:	6a 65                	push   $0x65
  jmp alltraps
80106ecd:	e9 ff f5 ff ff       	jmp    801064d1 <alltraps>
...
80106ed2:	6a 00                	push   $0x0
  pushl $102
80106ed4:	6a 66                	push   $0x66
  jmp alltraps
80106ed6:	e9 f6 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106edb:	6a 00                	push   $0x0
  pushl $103
80106edd:	6a 67                	push   $0x67
  jmp alltraps
80106edf:	e9 ed f5 ff ff       	jmp    801064d1 <alltraps>
...
80106ee4:	6a 00                	push   $0x0
  pushl $104
80106ee6:	6a 68                	push   $0x68
  jmp alltraps
80106ee8:	e9 e4 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106eed:	6a 00                	push   $0x0
  pushl $105
80106eef:	6a 69                	push   $0x69
  jmp alltraps
80106ef1:	e9 db f5 ff ff       	jmp    801064d1 <alltraps>
...
80106ef6:	6a 00                	push   $0x0
  pushl $106
80106ef8:	6a 6a                	push   $0x6a
  jmp alltraps
80106efa:	e9 d2 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106eff:	6a 00                	push   $0x0
  pushl $107
80106f01:	6a 6b                	push   $0x6b
  jmp alltraps
80106f03:	e9 c9 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f08:	6a 00                	push   $0x0
  pushl $108
80106f0a:	6a 6c                	push   $0x6c
  jmp alltraps
80106f0c:	e9 c0 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f11:	6a 00                	push   $0x0
  pushl $109
80106f13:	6a 6d                	push   $0x6d
  jmp alltraps
80106f15:	e9 b7 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f1a:	6a 00                	push   $0x0
  pushl $110
80106f1c:	6a 6e                	push   $0x6e
  jmp alltraps
80106f1e:	e9 ae f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f23:	6a 00                	push   $0x0
  pushl $111
80106f25:	6a 6f                	push   $0x6f
  jmp alltraps
80106f27:	e9 a5 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f2c:	6a 00                	push   $0x0
  pushl $112
80106f2e:	6a 70                	push   $0x70
  jmp alltraps
80106f30:	e9 9c f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f35:	6a 00                	push   $0x0
  pushl $113
80106f37:	6a 71                	push   $0x71
  jmp alltraps
80106f39:	e9 93 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f3e:	6a 00                	push   $0x0
  pushl $114
80106f40:	6a 72                	push   $0x72
  jmp alltraps
80106f42:	e9 8a f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f47:	6a 00                	push   $0x0
  pushl $115
80106f49:	6a 73                	push   $0x73
  jmp alltraps
80106f4b:	e9 81 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f50:	6a 00                	push   $0x0
  pushl $116
80106f52:	6a 74                	push   $0x74
  jmp alltraps
80106f54:	e9 78 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f59:	6a 00                	push   $0x0
  pushl $117
80106f5b:	6a 75                	push   $0x75
  jmp alltraps
80106f5d:	e9 6f f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f62:	6a 00                	push   $0x0
  pushl $118
80106f64:	6a 76                	push   $0x76
  jmp alltraps
80106f66:	e9 66 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f6b:	6a 00                	push   $0x0
  pushl $119
80106f6d:	6a 77                	push   $0x77
  jmp alltraps
80106f6f:	e9 5d f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f74:	6a 00                	push   $0x0
  pushl $120
80106f76:	6a 78                	push   $0x78
  jmp alltraps
80106f78:	e9 54 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f7d:	6a 00                	push   $0x0
  pushl $121
80106f7f:	6a 79                	push   $0x79
  jmp alltraps
80106f81:	e9 4b f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f86:	6a 00                	push   $0x0
  pushl $122
80106f88:	6a 7a                	push   $0x7a
  jmp alltraps
80106f8a:	e9 42 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f8f:	6a 00                	push   $0x0
  pushl $123
80106f91:	6a 7b                	push   $0x7b
  jmp alltraps
80106f93:	e9 39 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106f98:	6a 00                	push   $0x0
  pushl $124
80106f9a:	6a 7c                	push   $0x7c
  jmp alltraps
80106f9c:	e9 30 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106fa1:	6a 00                	push   $0x0
  pushl $125
80106fa3:	6a 7d                	push   $0x7d
  jmp alltraps
80106fa5:	e9 27 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106faa:	6a 00                	push   $0x0
  pushl $126
80106fac:	6a 7e                	push   $0x7e
  jmp alltraps
80106fae:	e9 1e f5 ff ff       	jmp    801064d1 <alltraps>
...
80106fb3:	6a 00                	push   $0x0
  pushl $127
80106fb5:	6a 7f                	push   $0x7f
  jmp alltraps
80106fb7:	e9 15 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106fbc:	6a 00                	push   $0x0
  pushl $128
80106fbe:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106fc3:	e9 09 f5 ff ff       	jmp    801064d1 <alltraps>
...
80106fc8:	6a 00                	push   $0x0
  pushl $129
80106fca:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106fcf:	e9 fd f4 ff ff       	jmp    801064d1 <alltraps>
...
80106fd4:	6a 00                	push   $0x0
  pushl $130
80106fd6:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106fdb:	e9 f1 f4 ff ff       	jmp    801064d1 <alltraps>
...
80106fe0:	6a 00                	push   $0x0
  pushl $131
80106fe2:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106fe7:	e9 e5 f4 ff ff       	jmp    801064d1 <alltraps>
...
80106fec:	6a 00                	push   $0x0
  pushl $132
80106fee:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106ff3:	e9 d9 f4 ff ff       	jmp    801064d1 <alltraps>
...
80106ff8:	6a 00                	push   $0x0
  pushl $133
80106ffa:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106fff:	e9 cd f4 ff ff       	jmp    801064d1 <alltraps>
...
80107004:	6a 00                	push   $0x0
  pushl $134
80107006:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010700b:	e9 c1 f4 ff ff       	jmp    801064d1 <alltraps>
...
80107010:	6a 00                	push   $0x0
  pushl $135
80107012:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107017:	e9 b5 f4 ff ff       	jmp    801064d1 <alltraps>
...
8010701c:	6a 00                	push   $0x0
  pushl $136
8010701e:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107023:	e9 a9 f4 ff ff       	jmp    801064d1 <alltraps>
...
80107028:	6a 00                	push   $0x0
  pushl $137
8010702a:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010702f:	e9 9d f4 ff ff       	jmp    801064d1 <alltraps>
...
80107034:	6a 00                	push   $0x0
  pushl $138
80107036:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010703b:	e9 91 f4 ff ff       	jmp    801064d1 <alltraps>
...
80107040:	6a 00                	push   $0x0
  pushl $139
80107042:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107047:	e9 85 f4 ff ff       	jmp    801064d1 <alltraps>
...
8010704c:	6a 00                	push   $0x0
  pushl $140
8010704e:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107053:	e9 79 f4 ff ff       	jmp    801064d1 <alltraps>
...
80107058:	6a 00                	push   $0x0
  pushl $141
8010705a:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010705f:	e9 6d f4 ff ff       	jmp    801064d1 <alltraps>
...
80107064:	6a 00                	push   $0x0
  pushl $142
80107066:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010706b:	e9 61 f4 ff ff       	jmp    801064d1 <alltraps>
...
80107070:	6a 00                	push   $0x0
  pushl $143
80107072:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107077:	e9 55 f4 ff ff       	jmp    801064d1 <alltraps>
...
8010707c:	6a 00                	push   $0x0
  pushl $144
8010707e:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107083:	e9 49 f4 ff ff       	jmp    801064d1 <alltraps>
...
80107088:	6a 00                	push   $0x0
  pushl $145
8010708a:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010708f:	e9 3d f4 ff ff       	jmp    801064d1 <alltraps>
...
80107094:	6a 00                	push   $0x0
  pushl $146
80107096:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010709b:	e9 31 f4 ff ff       	jmp    801064d1 <alltraps>
...
801070a0:	6a 00                	push   $0x0
  pushl $147
801070a2:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801070a7:	e9 25 f4 ff ff       	jmp    801064d1 <alltraps>
...
801070ac:	6a 00                	push   $0x0
  pushl $148
801070ae:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801070b3:	e9 19 f4 ff ff       	jmp    801064d1 <alltraps>
...
801070b8:	6a 00                	push   $0x0
  pushl $149
801070ba:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801070bf:	e9 0d f4 ff ff       	jmp    801064d1 <alltraps>
...
801070c4:	6a 00                	push   $0x0
  pushl $150
801070c6:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801070cb:	e9 01 f4 ff ff       	jmp    801064d1 <alltraps>
...
801070d0:	6a 00                	push   $0x0
  pushl $151
801070d2:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801070d7:	e9 f5 f3 ff ff       	jmp    801064d1 <alltraps>
...
801070dc:	6a 00                	push   $0x0
  pushl $152
801070de:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801070e3:	e9 e9 f3 ff ff       	jmp    801064d1 <alltraps>
...
801070e8:	6a 00                	push   $0x0
  pushl $153
801070ea:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801070ef:	e9 dd f3 ff ff       	jmp    801064d1 <alltraps>
...
801070f4:	6a 00                	push   $0x0
  pushl $154
801070f6:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801070fb:	e9 d1 f3 ff ff       	jmp    801064d1 <alltraps>
...
80107100:	6a 00                	push   $0x0
  pushl $155
80107102:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107107:	e9 c5 f3 ff ff       	jmp    801064d1 <alltraps>
...
8010710c:	6a 00                	push   $0x0
  pushl $156
8010710e:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107113:	e9 b9 f3 ff ff       	jmp    801064d1 <alltraps>
...
80107118:	6a 00                	push   $0x0
  pushl $157
8010711a:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010711f:	e9 ad f3 ff ff       	jmp    801064d1 <alltraps>
...
80107124:	6a 00                	push   $0x0
  pushl $158
80107126:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010712b:	e9 a1 f3 ff ff       	jmp    801064d1 <alltraps>
...
80107130:	6a 00                	push   $0x0
  pushl $159
80107132:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107137:	e9 95 f3 ff ff       	jmp    801064d1 <alltraps>
...
8010713c:	6a 00                	push   $0x0
  pushl $160
8010713e:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107143:	e9 89 f3 ff ff       	jmp    801064d1 <alltraps>
...
80107148:	6a 00                	push   $0x0
  pushl $161
8010714a:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010714f:	e9 7d f3 ff ff       	jmp    801064d1 <alltraps>
...
80107154:	6a 00                	push   $0x0
  pushl $162
80107156:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010715b:	e9 71 f3 ff ff       	jmp    801064d1 <alltraps>
...
80107160:	6a 00                	push   $0x0
  pushl $163
80107162:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107167:	e9 65 f3 ff ff       	jmp    801064d1 <alltraps>
...
8010716c:	6a 00                	push   $0x0
  pushl $164
8010716e:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107173:	e9 59 f3 ff ff       	jmp    801064d1 <alltraps>
...
80107178:	6a 00                	push   $0x0
  pushl $165
8010717a:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010717f:	e9 4d f3 ff ff       	jmp    801064d1 <alltraps>
...
80107184:	6a 00                	push   $0x0
  pushl $166
80107186:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010718b:	e9 41 f3 ff ff       	jmp    801064d1 <alltraps>
...
80107190:	6a 00                	push   $0x0
  pushl $167
80107192:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107197:	e9 35 f3 ff ff       	jmp    801064d1 <alltraps>
...
8010719c:	6a 00                	push   $0x0
  pushl $168
8010719e:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801071a3:	e9 29 f3 ff ff       	jmp    801064d1 <alltraps>
...
801071a8:	6a 00                	push   $0x0
  pushl $169
801071aa:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801071af:	e9 1d f3 ff ff       	jmp    801064d1 <alltraps>
...
801071b4:	6a 00                	push   $0x0
  pushl $170
801071b6:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801071bb:	e9 11 f3 ff ff       	jmp    801064d1 <alltraps>
...
801071c0:	6a 00                	push   $0x0
  pushl $171
801071c2:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801071c7:	e9 05 f3 ff ff       	jmp    801064d1 <alltraps>
...
801071cc:	6a 00                	push   $0x0
  pushl $172
801071ce:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801071d3:	e9 f9 f2 ff ff       	jmp    801064d1 <alltraps>
...
801071d8:	6a 00                	push   $0x0
  pushl $173
801071da:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801071df:	e9 ed f2 ff ff       	jmp    801064d1 <alltraps>
...
801071e4:	6a 00                	push   $0x0
  pushl $174
801071e6:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801071eb:	e9 e1 f2 ff ff       	jmp    801064d1 <alltraps>
...
801071f0:	6a 00                	push   $0x0
  pushl $175
801071f2:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801071f7:	e9 d5 f2 ff ff       	jmp    801064d1 <alltraps>
...
801071fc:	6a 00                	push   $0x0
  pushl $176
801071fe:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107203:	e9 c9 f2 ff ff       	jmp    801064d1 <alltraps>
...
80107208:	6a 00                	push   $0x0
  pushl $177
8010720a:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010720f:	e9 bd f2 ff ff       	jmp    801064d1 <alltraps>
...
80107214:	6a 00                	push   $0x0
  pushl $178
80107216:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010721b:	e9 b1 f2 ff ff       	jmp    801064d1 <alltraps>
...
80107220:	6a 00                	push   $0x0
  pushl $179
80107222:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107227:	e9 a5 f2 ff ff       	jmp    801064d1 <alltraps>
...
8010722c:	6a 00                	push   $0x0
  pushl $180
8010722e:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107233:	e9 99 f2 ff ff       	jmp    801064d1 <alltraps>
...
80107238:	6a 00                	push   $0x0
  pushl $181
8010723a:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010723f:	e9 8d f2 ff ff       	jmp    801064d1 <alltraps>
...
80107244:	6a 00                	push   $0x0
  pushl $182
80107246:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010724b:	e9 81 f2 ff ff       	jmp    801064d1 <alltraps>
...
80107250:	6a 00                	push   $0x0
  pushl $183
80107252:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107257:	e9 75 f2 ff ff       	jmp    801064d1 <alltraps>
...
8010725c:	6a 00                	push   $0x0
  pushl $184
8010725e:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107263:	e9 69 f2 ff ff       	jmp    801064d1 <alltraps>
...
80107268:	6a 00                	push   $0x0
  pushl $185
8010726a:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010726f:	e9 5d f2 ff ff       	jmp    801064d1 <alltraps>
...
80107274:	6a 00                	push   $0x0
  pushl $186
80107276:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010727b:	e9 51 f2 ff ff       	jmp    801064d1 <alltraps>
...
80107280:	6a 00                	push   $0x0
  pushl $187
80107282:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107287:	e9 45 f2 ff ff       	jmp    801064d1 <alltraps>
...
8010728c:	6a 00                	push   $0x0
  pushl $188
8010728e:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107293:	e9 39 f2 ff ff       	jmp    801064d1 <alltraps>
...
80107298:	6a 00                	push   $0x0
  pushl $189
8010729a:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010729f:	e9 2d f2 ff ff       	jmp    801064d1 <alltraps>
...
801072a4:	6a 00                	push   $0x0
  pushl $190
801072a6:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801072ab:	e9 21 f2 ff ff       	jmp    801064d1 <alltraps>
...
801072b0:	6a 00                	push   $0x0
  pushl $191
801072b2:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801072b7:	e9 15 f2 ff ff       	jmp    801064d1 <alltraps>
...
801072bc:	6a 00                	push   $0x0
  pushl $192
801072be:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801072c3:	e9 09 f2 ff ff       	jmp    801064d1 <alltraps>
...
801072c8:	6a 00                	push   $0x0
  pushl $193
801072ca:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801072cf:	e9 fd f1 ff ff       	jmp    801064d1 <alltraps>
...
801072d4:	6a 00                	push   $0x0
  pushl $194
801072d6:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801072db:	e9 f1 f1 ff ff       	jmp    801064d1 <alltraps>
...
801072e0:	6a 00                	push   $0x0
  pushl $195
801072e2:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801072e7:	e9 e5 f1 ff ff       	jmp    801064d1 <alltraps>
...
801072ec:	6a 00                	push   $0x0
  pushl $196
801072ee:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801072f3:	e9 d9 f1 ff ff       	jmp    801064d1 <alltraps>
...
801072f8:	6a 00                	push   $0x0
  pushl $197
801072fa:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801072ff:	e9 cd f1 ff ff       	jmp    801064d1 <alltraps>
...
80107304:	6a 00                	push   $0x0
  pushl $198
80107306:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010730b:	e9 c1 f1 ff ff       	jmp    801064d1 <alltraps>
...
80107310:	6a 00                	push   $0x0
  pushl $199
80107312:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107317:	e9 b5 f1 ff ff       	jmp    801064d1 <alltraps>
...
8010731c:	6a 00                	push   $0x0
  pushl $200
8010731e:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107323:	e9 a9 f1 ff ff       	jmp    801064d1 <alltraps>
...
80107328:	6a 00                	push   $0x0
  pushl $201
8010732a:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010732f:	e9 9d f1 ff ff       	jmp    801064d1 <alltraps>
...
80107334:	6a 00                	push   $0x0
  pushl $202
80107336:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010733b:	e9 91 f1 ff ff       	jmp    801064d1 <alltraps>
...
80107340:	6a 00                	push   $0x0
  pushl $203
80107342:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107347:	e9 85 f1 ff ff       	jmp    801064d1 <alltraps>
...
8010734c:	6a 00                	push   $0x0
  pushl $204
8010734e:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107353:	e9 79 f1 ff ff       	jmp    801064d1 <alltraps>
...
80107358:	6a 00                	push   $0x0
  pushl $205
8010735a:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010735f:	e9 6d f1 ff ff       	jmp    801064d1 <alltraps>
...
80107364:	6a 00                	push   $0x0
  pushl $206
80107366:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010736b:	e9 61 f1 ff ff       	jmp    801064d1 <alltraps>
...
80107370:	6a 00                	push   $0x0
  pushl $207
80107372:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107377:	e9 55 f1 ff ff       	jmp    801064d1 <alltraps>
...
8010737c:	6a 00                	push   $0x0
  pushl $208
8010737e:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107383:	e9 49 f1 ff ff       	jmp    801064d1 <alltraps>
...
80107388:	6a 00                	push   $0x0
  pushl $209
8010738a:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010738f:	e9 3d f1 ff ff       	jmp    801064d1 <alltraps>
...
80107394:	6a 00                	push   $0x0
  pushl $210
80107396:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010739b:	e9 31 f1 ff ff       	jmp    801064d1 <alltraps>
...
801073a0:	6a 00                	push   $0x0
  pushl $211
801073a2:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801073a7:	e9 25 f1 ff ff       	jmp    801064d1 <alltraps>
...
801073ac:	6a 00                	push   $0x0
  pushl $212
801073ae:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801073b3:	e9 19 f1 ff ff       	jmp    801064d1 <alltraps>
...
801073b8:	6a 00                	push   $0x0
  pushl $213
801073ba:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801073bf:	e9 0d f1 ff ff       	jmp    801064d1 <alltraps>
...
801073c4:	6a 00                	push   $0x0
  pushl $214
801073c6:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801073cb:	e9 01 f1 ff ff       	jmp    801064d1 <alltraps>
...
801073d0:	6a 00                	push   $0x0
  pushl $215
801073d2:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801073d7:	e9 f5 f0 ff ff       	jmp    801064d1 <alltraps>
...
801073dc:	6a 00                	push   $0x0
  pushl $216
801073de:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801073e3:	e9 e9 f0 ff ff       	jmp    801064d1 <alltraps>
...
801073e8:	6a 00                	push   $0x0
  pushl $217
801073ea:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801073ef:	e9 dd f0 ff ff       	jmp    801064d1 <alltraps>
...
801073f4:	6a 00                	push   $0x0
  pushl $218
801073f6:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801073fb:	e9 d1 f0 ff ff       	jmp    801064d1 <alltraps>
...
80107400:	6a 00                	push   $0x0
  pushl $219
80107402:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107407:	e9 c5 f0 ff ff       	jmp    801064d1 <alltraps>
...
8010740c:	6a 00                	push   $0x0
  pushl $220
8010740e:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107413:	e9 b9 f0 ff ff       	jmp    801064d1 <alltraps>
...
80107418:	6a 00                	push   $0x0
  pushl $221
8010741a:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010741f:	e9 ad f0 ff ff       	jmp    801064d1 <alltraps>
...
80107424:	6a 00                	push   $0x0
  pushl $222
80107426:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010742b:	e9 a1 f0 ff ff       	jmp    801064d1 <alltraps>
...
80107430:	6a 00                	push   $0x0
  pushl $223
80107432:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107437:	e9 95 f0 ff ff       	jmp    801064d1 <alltraps>
...
8010743c:	6a 00                	push   $0x0
  pushl $224
8010743e:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107443:	e9 89 f0 ff ff       	jmp    801064d1 <alltraps>
...
80107448:	6a 00                	push   $0x0
  pushl $225
8010744a:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010744f:	e9 7d f0 ff ff       	jmp    801064d1 <alltraps>
...
80107454:	6a 00                	push   $0x0
  pushl $226
80107456:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010745b:	e9 71 f0 ff ff       	jmp    801064d1 <alltraps>
...
80107460:	6a 00                	push   $0x0
  pushl $227
80107462:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107467:	e9 65 f0 ff ff       	jmp    801064d1 <alltraps>
...
8010746c:	6a 00                	push   $0x0
  pushl $228
8010746e:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107473:	e9 59 f0 ff ff       	jmp    801064d1 <alltraps>
...
80107478:	6a 00                	push   $0x0
  pushl $229
8010747a:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010747f:	e9 4d f0 ff ff       	jmp    801064d1 <alltraps>
...
80107484:	6a 00                	push   $0x0
  pushl $230
80107486:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010748b:	e9 41 f0 ff ff       	jmp    801064d1 <alltraps>
...
80107490:	6a 00                	push   $0x0
  pushl $231
80107492:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107497:	e9 35 f0 ff ff       	jmp    801064d1 <alltraps>
...
8010749c:	6a 00                	push   $0x0
  pushl $232
8010749e:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801074a3:	e9 29 f0 ff ff       	jmp    801064d1 <alltraps>
...
801074a8:	6a 00                	push   $0x0
  pushl $233
801074aa:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801074af:	e9 1d f0 ff ff       	jmp    801064d1 <alltraps>
...
801074b4:	6a 00                	push   $0x0
  pushl $234
801074b6:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801074bb:	e9 11 f0 ff ff       	jmp    801064d1 <alltraps>
...
801074c0:	6a 00                	push   $0x0
  pushl $235
801074c2:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801074c7:	e9 05 f0 ff ff       	jmp    801064d1 <alltraps>
...
801074cc:	6a 00                	push   $0x0
  pushl $236
801074ce:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801074d3:	e9 f9 ef ff ff       	jmp    801064d1 <alltraps>
...
801074d8:	6a 00                	push   $0x0
  pushl $237
801074da:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801074df:	e9 ed ef ff ff       	jmp    801064d1 <alltraps>
...
801074e4:	6a 00                	push   $0x0
  pushl $238
801074e6:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801074eb:	e9 e1 ef ff ff       	jmp    801064d1 <alltraps>
...
801074f0:	6a 00                	push   $0x0
  pushl $239
801074f2:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801074f7:	e9 d5 ef ff ff       	jmp    801064d1 <alltraps>
...
801074fc:	6a 00                	push   $0x0
  pushl $240
801074fe:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107503:	e9 c9 ef ff ff       	jmp    801064d1 <alltraps>
...
80107508:	6a 00                	push   $0x0
  pushl $241
8010750a:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010750f:	e9 bd ef ff ff       	jmp    801064d1 <alltraps>
...
80107514:	6a 00                	push   $0x0
  pushl $242
80107516:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010751b:	e9 b1 ef ff ff       	jmp    801064d1 <alltraps>
...
80107520:	6a 00                	push   $0x0
  pushl $243
80107522:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107527:	e9 a5 ef ff ff       	jmp    801064d1 <alltraps>
...
8010752c:	6a 00                	push   $0x0
  pushl $244
8010752e:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107533:	e9 99 ef ff ff       	jmp    801064d1 <alltraps>
...
80107538:	6a 00                	push   $0x0
  pushl $245
8010753a:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010753f:	e9 8d ef ff ff       	jmp    801064d1 <alltraps>
...
80107544:	6a 00                	push   $0x0
  pushl $246
80107546:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010754b:	e9 81 ef ff ff       	jmp    801064d1 <alltraps>
...
80107550:	6a 00                	push   $0x0
  pushl $247
80107552:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107557:	e9 75 ef ff ff       	jmp    801064d1 <alltraps>
...
8010755c:	6a 00                	push   $0x0
  pushl $248
8010755e:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107563:	e9 69 ef ff ff       	jmp    801064d1 <alltraps>
...
80107568:	6a 00                	push   $0x0
  pushl $249
8010756a:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010756f:	e9 5d ef ff ff       	jmp    801064d1 <alltraps>
...
80107574:	6a 00                	push   $0x0
  pushl $250
80107576:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010757b:	e9 51 ef ff ff       	jmp    801064d1 <alltraps>
...
80107580:	6a 00                	push   $0x0
  pushl $251
80107582:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107587:	e9 45 ef ff ff       	jmp    801064d1 <alltraps>
...
8010758c:	6a 00                	push   $0x0
  pushl $252
8010758e:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107593:	e9 39 ef ff ff       	jmp    801064d1 <alltraps>
...
80107598:	6a 00                	push   $0x0
  pushl $253
8010759a:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010759f:	e9 2d ef ff ff       	jmp    801064d1 <alltraps>
...
801075a4:	6a 00                	push   $0x0
  pushl $254
801075a6:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801075ab:	e9 21 ef ff ff       	jmp    801064d1 <alltraps>
...
801075b0:	6a 00                	push   $0x0
  pushl $255
801075b2:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801075b7:	e9 15 ef ff ff       	jmp    801064d1 <alltraps>
...
801075bf:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801075c2:	8b 45 0c             	mov    0xc(%ebp),%eax
801075c5:	83 e8 01             	sub    $0x1,%eax
801075c8:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801075cc:	8b 45 08             	mov    0x8(%ebp),%eax
801075cf:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801075d3:	8b 45 08             	mov    0x8(%ebp),%eax
801075d6:	c1 e8 10             	shr    $0x10,%eax
801075d9:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
801075dd:	8d 45 fa             	lea    -0x6(%ebp),%eax
801075e0:	0f 01 10             	lgdtl  (%eax)
}
801075e3:	c9                   	leave  
801075e4:	c3                   	ret    
...
801075ee:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801075f2:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801075f6:	0f 00 d8             	ltr    %ax
}
801075f9:	c9                   	leave  
801075fa:	c3                   	ret    
...
80107604:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107608:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010760c:	8e e8                	mov    %eax,%gs
}
8010760e:	c9                   	leave  
8010760f:	c3                   	ret    
...
80107628 <p2v>:
static inline void *p2v(uint a) { return (void *) ((a) + KERNBASE); }
80107628:	55                   	push   %ebp
80107629:	89 e5                	mov    %esp,%ebp
...
seginit(void)
{
80107635:	55                   	push   %ebp
80107636:	89 e5                	mov    %esp,%ebp
80107638:	53                   	push   %ebx
80107639:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
8010763c:	e8 d2 b8 ff ff       	call   80102f13 <cpunum>
80107641:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107647:	05 80 23 11 80       	add    $0x80112380,%eax
8010764c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010764f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107652:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107658:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010765b:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107661:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107664:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107668:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010766b:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010766f:	83 e2 f0             	and    $0xfffffff0,%edx
80107672:	83 ca 0a             	or     $0xa,%edx
...
80107688:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010768c:	83 e2 9f             	and    $0xffffff9f,%edx
8010768f:	88 50 7d             	mov    %dl,0x7d(%eax)
80107692:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107695:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
...
801076c0:	83 e2 df             	and    $0xffffffdf,%edx
...
801076e3:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801076e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076ea:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
801076f1:	ff ff 
801076f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076f6:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801076fd:	00 00 
801076ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107702:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107709:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010770c:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107713:	83 e2 f0             	and    $0xfffffff0,%edx
80107716:	83 ca 02             	or     $0x2,%edx
80107719:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010771f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107722:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107729:	83 ca 10             	or     $0x10,%edx
8010772c:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107732:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107735:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010773c:	83 e2 9f             	and    $0xffffff9f,%edx
8010773f:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107745:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107748:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010774f:	83 ca 80             	or     $0xffffff80,%edx
80107752:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107758:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010775b:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107762:	83 ca 0f             	or     $0xf,%edx
80107765:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010776b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010776e:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107775:	83 e2 ef             	and    $0xffffffef,%edx
80107778:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010777e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107781:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107788:	83 e2 df             	and    $0xffffffdf,%edx
8010778b:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107791:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107794:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010779b:	83 ca 40             	or     $0x40,%edx
8010779e:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801077a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077a7:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801077ae:	83 ca 80             	or     $0xffffff80,%edx
801077b1:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801077b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ba:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801077c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c4:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801077cb:	ff ff 
801077cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077d0:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
801077d7:	00 00 
801077d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077dc:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
801077e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077e6:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801077ed:	83 e2 f0             	and    $0xfffffff0,%edx
801077f0:	83 ca 0a             	or     $0xa,%edx
801077f3:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801077f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077fc:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
...
80107835:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010783c:	83 ca 0f             	or     $0xf,%edx
8010783f:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
...
80107862:	83 e2 df             	and    $0xffffffdf,%edx
...
80107894:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010789b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010789e:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801078a5:	ff ff 
801078a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078aa:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801078b1:	00 00 
801078b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078b6:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801078bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078c0:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801078c7:	83 e2 f0             	and    $0xfffffff0,%edx
801078ca:	83 ca 02             	or     $0x2,%edx
801078cd:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801078d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d6:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801078dd:	83 ca 10             	or     $0x10,%edx
801078e0:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801078e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078e9:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801078f0:	83 ca 60             	or     $0x60,%edx
801078f3:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801078f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078fc:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107903:	83 ca 80             	or     $0xffffff80,%edx
80107906:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010790c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010790f:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107916:	83 ca 0f             	or     $0xf,%edx
80107919:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010791f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107922:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107929:	83 e2 ef             	and    $0xffffffef,%edx
8010792c:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107932:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107935:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010793c:	83 e2 df             	and    $0xffffffdf,%edx
8010793f:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107945:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107948:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010794f:	83 ca 40             	or     $0x40,%edx
80107952:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107958:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010795b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107962:	83 ca 80             	or     $0xffffff80,%edx
80107965:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010796b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010796e:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107975:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107978:	05 b4 00 00 00       	add    $0xb4,%eax
8010797d:	89 c3                	mov    %eax,%ebx
8010797f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107982:	05 b4 00 00 00       	add    $0xb4,%eax
80107987:	c1 e8 10             	shr    $0x10,%eax
8010798a:	89 c1                	mov    %eax,%ecx
8010798c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010798f:	05 b4 00 00 00       	add    $0xb4,%eax
80107994:	c1 e8 18             	shr    $0x18,%eax
80107997:	89 c2                	mov    %eax,%edx
80107999:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010799c:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801079a3:	00 00 
801079a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079a8:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801079af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b2:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801079b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079bb:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801079c2:	83 e1 f0             	and    $0xfffffff0,%ecx
801079c5:	83 c9 02             	or     $0x2,%ecx
801079c8:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801079ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d1:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801079d8:	83 c9 10             	or     $0x10,%ecx
801079db:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801079e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079e4:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801079eb:	83 e1 9f             	and    $0xffffff9f,%ecx
801079ee:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801079f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079f7:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801079fe:	83 c9 80             	or     $0xffffff80,%ecx
80107a01:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107a07:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a0a:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a11:	83 e1 f0             	and    $0xfffffff0,%ecx
80107a14:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107a1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a1d:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a24:	83 e1 ef             	and    $0xffffffef,%ecx
80107a27:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107a2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a30:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a37:	83 e1 df             	and    $0xffffffdf,%ecx
80107a3a:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107a40:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a43:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a4a:	83 c9 40             	or     $0x40,%ecx
80107a4d:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107a53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a56:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a5d:	83 c9 80             	or     $0xffffff80,%ecx
80107a60:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107a66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a69:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107a6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a72:	83 c0 70             	add    $0x70,%eax
80107a75:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107a7c:	00 
80107a7d:	89 04 24             	mov    %eax,(%esp)
80107a80:	e8 37 fb ff ff       	call   801075bc <lgdt>
  loadgs(SEG_KCPU << 3);
80107a85:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107a8c:	e8 6a fb ff ff       	call   801075fb <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107a91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a94:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107a9a:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107aa1:	00 00 00 00 
}
80107aa5:	83 c4 24             	add    $0x24,%esp
80107aa8:	5b                   	pop    %ebx
80107aa9:	5d                   	pop    %ebp
80107aaa:	c3                   	ret    
...
80107aae:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107ab1:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ab4:	c1 e8 16             	shr    $0x16,%eax
80107ab7:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107abe:	8b 45 08             	mov    0x8(%ebp),%eax
80107ac1:	01 d0                	add    %edx,%eax
80107ac3:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107ac6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ac9:	8b 00                	mov    (%eax),%eax
80107acb:	83 e0 01             	and    $0x1,%eax
80107ace:	85 c0                	test   %eax,%eax
80107ad0:	74 17                	je     80107ae9 <walkpgdir+0x3e>
...
80107adf:	e8 44 fb ff ff       	call   80107628 <p2v>
80107ae4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107ae7:	eb 4b                	jmp    80107b34 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107ae9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107aed:	74 0e                	je     80107afd <walkpgdir+0x52>
80107aef:	e8 89 b0 ff ff       	call   80102b7d <kalloc>
80107af4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107af7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107afb:	75 07                	jne    80107b04 <walkpgdir+0x59>
      return 0;
80107afd:	b8 00 00 00 00       	mov    $0x0,%eax
80107b02:	eb 47                	jmp    80107b4b <walkpgdir+0xa0>
...
80107b1a:	e8 be d5 ff ff       	call   801050dd <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = v2p(pgtab) | PTE_P | PTE_W | PTE_U;
80107b1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b22:	89 04 24             	mov    %eax,(%esp)
80107b25:	e8 f1 fa ff ff       	call   8010761b <v2p>
...
80107b86:	e8 20 ff ff ff       	call   80107aab <walkpgdir>
...
80107ba5:	74 0c                	je     80107bb3 <mappages+0x66>
      panic("remap");
80107ba7:	c7 04 24 48 8a 10 80 	movl   $0x80108a48,(%esp)
80107bae:	e8 87 89 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
...
80107bec:	e8 8c af ff ff       	call   80102b7d <kalloc>
...
80107bff:	e9 98 00 00 00       	jmp    80107c9c <setupkvm+0xb7>
...
80107c1a:	e8 be d4 ff ff       	call   801050dd <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107c1f:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107c26:	e8 fd f9 ff ff       	call   80107628 <p2v>
80107c2b:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107c30:	76 0c                	jbe    80107c3e <setupkvm+0x59>
    panic("PHYSTOP too high");
80107c32:	c7 04 24 4e 8a 10 80 	movl   $0x80108a4e,(%esp)
80107c39:	e8 fc 88 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c3e:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107c45:	eb 49                	jmp    80107c90 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107c47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c4a:	8b 48 0c             	mov    0xc(%eax),%ecx
80107c4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c50:	8b 50 04             	mov    0x4(%eax),%edx
80107c53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c56:	8b 58 08             	mov    0x8(%eax),%ebx
80107c59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c5c:	8b 40 04             	mov    0x4(%eax),%eax
80107c5f:	29 c3                	sub    %eax,%ebx
80107c61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c64:	8b 00                	mov    (%eax),%eax
80107c66:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107c6a:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107c6e:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107c72:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c76:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c79:	89 04 24             	mov    %eax,(%esp)
80107c7c:	e8 cc fe ff ff       	call   80107b4d <mappages>
80107c81:	85 c0                	test   %eax,%eax
80107c83:	79 07                	jns    80107c8c <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107c85:	b8 00 00 00 00       	mov    $0x0,%eax
80107c8a:	eb 10                	jmp    80107c9c <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c8c:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107c90:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107c97:	72 ae                	jb     80107c47 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107c9c:	83 c4 34             	add    $0x34,%esp
80107c9f:	5b                   	pop    %ebx
80107ca0:	5d                   	pop    %ebp
80107ca1:	c3                   	ret    
...
80107ca5:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107ca8:	e8 38 ff ff ff       	call   80107be5 <setupkvm>
80107cad:	a3 58 51 11 80       	mov    %eax,0x80115158
  switchkvm();
80107cb2:	e8 02 00 00 00       	call   80107cb9 <switchkvm>
}
80107cb7:	c9                   	leave  
80107cb8:	c3                   	ret    
...
80107cbf:	a1 58 51 11 80       	mov    0x80115158,%eax
80107cc4:	89 04 24             	mov    %eax,(%esp)
80107cc7:	e8 4f f9 ff ff       	call   8010761b <v2p>
80107ccc:	89 04 24             	mov    %eax,(%esp)
80107ccf:	e8 3c f9 ff ff       	call   80107610 <lcr3>
}
80107cd4:	c9                   	leave  
80107cd5:	c3                   	ret    
...
80107cda:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107cdd:	e8 fb d2 ff ff       	call   80104fdd <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107ce2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ce8:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107cef:	83 c2 08             	add    $0x8,%edx
80107cf2:	89 d3                	mov    %edx,%ebx
80107cf4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107cfb:	83 c2 08             	add    $0x8,%edx
80107cfe:	c1 ea 10             	shr    $0x10,%edx
80107d01:	89 d1                	mov    %edx,%ecx
80107d03:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107d0a:	83 c2 08             	add    $0x8,%edx
80107d0d:	c1 ea 18             	shr    $0x18,%edx
80107d10:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107d17:	67 00 
80107d19:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107d20:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107d26:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d2d:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d30:	83 c9 09             	or     $0x9,%ecx
80107d33:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d39:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d40:	83 c9 10             	or     $0x10,%ecx
80107d43:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d49:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d50:	83 e1 9f             	and    $0xffffff9f,%ecx
80107d53:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d59:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d60:	83 c9 80             	or     $0xffffff80,%ecx
80107d63:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d69:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d70:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d73:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d79:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d80:	83 e1 ef             	and    $0xffffffef,%ecx
80107d83:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d89:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d90:	83 e1 df             	and    $0xffffffdf,%ecx
80107d93:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d99:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107da0:	83 c9 40             	or     $0x40,%ecx
80107da3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107da9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107db0:	83 e1 7f             	and    $0x7f,%ecx
80107db3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107db9:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107dbf:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107dc5:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107dcc:	83 e2 ef             	and    $0xffffffef,%edx
80107dcf:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107dd5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ddb:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107de1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107de7:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107dee:	8b 52 08             	mov    0x8(%edx),%edx
80107df1:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107df7:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107dfa:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107e01:	e8 df f7 ff ff       	call   801075e5 <ltr>
  if(p->pgdir == 0)
80107e06:	8b 45 08             	mov    0x8(%ebp),%eax
80107e09:	8b 40 04             	mov    0x4(%eax),%eax
80107e0c:	85 c0                	test   %eax,%eax
80107e0e:	75 0c                	jne    80107e1c <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107e10:	c7 04 24 5f 8a 10 80 	movl   $0x80108a5f,(%esp)
80107e17:	e8 1e 87 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107e1c:	8b 45 08             	mov    0x8(%ebp),%eax
80107e1f:	8b 40 04             	mov    0x4(%eax),%eax
80107e22:	89 04 24             	mov    %eax,(%esp)
80107e25:	e8 f1 f7 ff ff       	call   8010761b <v2p>
80107e2a:	89 04 24             	mov    %eax,(%esp)
80107e2d:	e8 de f7 ff ff       	call   80107610 <lcr3>
  popcli();
80107e32:	e8 ea d1 ff ff       	call   80105021 <popcli>
}
80107e37:	83 c4 14             	add    $0x14,%esp
80107e3a:	5b                   	pop    %ebx
80107e3b:	5d                   	pop    %ebp
80107e3c:	c3                   	ret    
...
80107e40:	83 ec 38             	sub    $0x38,%esp
  ...
  if(sz >= PGSIZE)
80107e43:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107e4a:	76 0c                	jbe    80107e58 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107e4c:	c7 04 24 73 8a 10 80 	movl   $0x80108a73,(%esp)
80107e53:	e8 e2 86 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107e58:	e8 20 ad ff ff       	call   80102b7d <kalloc>
...
80107e76:	e8 62 d2 ff ff       	call   801050dd <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107e7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e7e:	89 04 24             	mov    %eax,(%esp)
80107e81:	e8 95 f7 ff ff       	call   8010761b <v2p>
80107e86:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107e8d:	00 
80107e8e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107e92:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e99:	00 
80107e9a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107ea1:	00 
80107ea2:	8b 45 08             	mov    0x8(%ebp),%eax
80107ea5:	89 04 24             	mov    %eax,(%esp)
80107ea8:	e8 a0 fc ff ff       	call   80107b4d <mappages>
  memmove(mem, init, sz);
80107ead:	8b 45 10             	mov    0x10(%ebp),%eax
80107eb0:	89 44 24 08          	mov    %eax,0x8(%esp)
80107eb4:	8b 45 0c             	mov    0xc(%ebp),%eax
80107eb7:	89 44 24 04          	mov    %eax,0x4(%esp)
80107ebb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ebe:	89 04 24             	mov    %eax,(%esp)
80107ec1:	e8 e6 d2 ff ff       	call   801051ac <memmove>
}
80107ec6:	c9                   	leave  
80107ec7:	c3                   	ret    
...
80107ecc:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107ecf:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ed2:	25 ff 0f 00 00       	and    $0xfff,%eax
80107ed7:	85 c0                	test   %eax,%eax
80107ed9:	74 0c                	je     80107ee7 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107edb:	c7 04 24 90 8a 10 80 	movl   $0x80108a90,(%esp)
80107ee2:	e8 53 86 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107ee7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107eee:	e9 a9 00 00 00       	jmp    80107f9c <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107ef3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ef6:	8b 55 0c             	mov    0xc(%ebp),%edx
80107ef9:	01 d0                	add    %edx,%eax
80107efb:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f02:	00 
80107f03:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f07:	8b 45 08             	mov    0x8(%ebp),%eax
80107f0a:	89 04 24             	mov    %eax,(%esp)
80107f0d:	e8 99 fb ff ff       	call   80107aab <walkpgdir>
80107f12:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107f15:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107f19:	75 0c                	jne    80107f27 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107f1b:	c7 04 24 b3 8a 10 80 	movl   $0x80108ab3,(%esp)
80107f22:	e8 13 86 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80107f27:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107f2a:	8b 00                	mov    (%eax),%eax
80107f2c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107f31:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107f34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f37:	8b 55 18             	mov    0x18(%ebp),%edx
80107f3a:	29 c2                	sub    %eax,%edx
80107f3c:	89 d0                	mov    %edx,%eax
80107f3e:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107f43:	77 0f                	ja     80107f54 <loaduvm+0x8c>
      n = sz - i;
80107f45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f48:	8b 55 18             	mov    0x18(%ebp),%edx
80107f4b:	29 c2                	sub    %eax,%edx
80107f4d:	89 d0                	mov    %edx,%eax
80107f4f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107f52:	eb 07                	jmp    80107f5b <loaduvm+0x93>
    else
      n = PGSIZE;
80107f54:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107f5b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f5e:	8b 55 14             	mov    0x14(%ebp),%edx
80107f61:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107f64:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f67:	89 04 24             	mov    %eax,(%esp)
80107f6a:	e8 b9 f6 ff ff       	call   80107628 <p2v>
80107f6f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107f72:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107f76:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107f7a:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f7e:	8b 45 10             	mov    0x10(%ebp),%eax
80107f81:	89 04 24             	mov    %eax,(%esp)
80107f84:	e8 43 9e ff ff       	call   80101dcc <readi>
80107f89:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107f8c:	74 07                	je     80107f95 <loaduvm+0xcd>
      return -1;
80107f8e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107f93:	eb 18                	jmp    80107fad <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
80107f9f:	3b 45 18             	cmp    0x18(%ebp),%eax
80107fa2:	0f 82 4b ff ff ff    	jb     80107ef3 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80107fad:	83 c4 24             	add    $0x24,%esp
80107fb0:	5b                   	pop    %ebx
80107fb1:	5d                   	pop    %ebp
80107fb2:	c3                   	ret    
...
80107fb6:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107fbe:	79 0a                	jns    80107fca <allocuvm+0x17>
    return 0;
80107fc0:	b8 00 00 00 00       	mov    $0x0,%eax
80107fc5:	e9 c1 00 00 00       	jmp    8010808b <allocuvm+0xd8>
  if(newsz < oldsz)
80107fca:	8b 45 10             	mov    0x10(%ebp),%eax
80107fcd:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107fd0:	73 08                	jae    80107fda <allocuvm+0x27>
    return oldsz;
80107fd2:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fd5:	e9 b1 00 00 00       	jmp    8010808b <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80107fda:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fdd:	05 ff 0f 00 00       	add    $0xfff,%eax
80107fe2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107fe7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107fea:	e9 8d 00 00 00       	jmp    8010807c <allocuvm+0xc9>
    mem = kalloc();
80107fef:	e8 89 ab ff ff       	call   80102b7d <kalloc>
80107ff4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107ff7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107ffb:	75 2c                	jne    80108029 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80107ffd:	c7 04 24 d1 8a 10 80 	movl   $0x80108ad1,(%esp)
80108004:	e8 97 83 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108009:	8b 45 0c             	mov    0xc(%ebp),%eax
8010800c:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010801d:	e8 6b 00 00 00       	call   8010808d <deallocuvm>
      return 0;
80108022:	b8 00 00 00 00       	mov    $0x0,%eax
80108027:	eb 62                	jmp    8010808b <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
...
8010803f:	e8 99 d0 ff ff       	call   801050dd <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108044:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108047:	89 04 24             	mov    %eax,(%esp)
8010804a:	e8 cc f5 ff ff       	call   8010761b <v2p>
8010804f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108052:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108059:	00 
8010805a:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010805e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108065:	00 
80108066:	89 54 24 04          	mov    %edx,0x4(%esp)
8010806a:	8b 45 08             	mov    0x8(%ebp),%eax
8010806d:	89 04 24             	mov    %eax,(%esp)
80108070:	e8 d8 fa ff ff       	call   80107b4d <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80108082:	0f 82 67 ff ff ff    	jb     80107fef <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
8010809e:	e9 a4 00 00 00       	jmp    80108147 <deallocuvm+0xba>
...
801080b3:	e9 80 00 00 00       	jmp    80108138 <deallocuvm+0xab>
...
801080cd:	e8 d9 f9 ff ff       	call   80107aab <walkpgdir>
801080d2:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801080d5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801080d9:	75 09                	jne    801080e4 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801080db:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801080e2:	eb 4d                	jmp    80108131 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
801080e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080e7:	8b 00                	mov    (%eax),%eax
801080e9:	83 e0 01             	and    $0x1,%eax
801080ec:	85 c0                	test   %eax,%eax
801080ee:	74 41                	je     80108131 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
80108101:	75 0c                	jne    8010810f <deallocuvm+0x82>
        panic("kfree");
80108103:	c7 04 24 e9 8a 10 80 	movl   $0x80108ae9,(%esp)
8010810a:	e8 2b 84 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
8010810f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108112:	89 04 24             	mov    %eax,(%esp)
80108115:	e8 0e f5 ff ff       	call   80107628 <p2v>
8010811a:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010811d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108120:	89 04 24             	mov    %eax,(%esp)
80108123:	e8 bc a9 ff ff       	call   80102ae4 <kfree>
      *pte = 0;
80108128:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010812b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
8010813b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010813e:	0f 82 74 ff ff ff    	jb     801080b8 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
8010814c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
8010814f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108153:	75 0c                	jne    80108161 <freevm+0x18>
    panic("freevm: no pgdir");
80108155:	c7 04 24 ef 8a 10 80 	movl   $0x80108aef,(%esp)
8010815c:	e8 d9 83 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108161:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108168:	00 
80108169:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108170:	80 
80108171:	8b 45 08             	mov    0x8(%ebp),%eax
80108174:	89 04 24             	mov    %eax,(%esp)
80108177:	e8 11 ff ff ff       	call   8010808d <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010817c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108183:	eb 48                	jmp    801081cd <freevm+0x84>
    if(pgdir[i] & PTE_P){
...
80108196:	83 e0 01             	and    $0x1,%eax
80108199:	85 c0                	test   %eax,%eax
8010819b:	74 2c                	je     801081c9 <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
8010819d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081a0:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
801081c4:	e8 1b a9 ff ff       	call   80102ae4 <kfree>
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801081c9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801081cd:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801081d4:	76 af                	jbe    80108185 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801081dc:	e8 03 a9 ff ff       	call   80102ae4 <kfree>
}
801081e1:	c9                   	leave  
801081e2:	c3                   	ret    
...
801081fe:	e8 a8 f8 ff ff       	call   80107aab <walkpgdir>
80108203:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108206:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010820a:	75 0c                	jne    80108218 <clearpteu+0x35>
    panic("clearpteu");
8010820c:	c7 04 24 00 8b 10 80 	movl   $0x80108b00,(%esp)
80108213:	e8 22 83 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80108218:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010821b:	8b 00                	mov    (%eax),%eax
8010821d:	83 e0 fb             	and    $0xfffffffb,%eax
80108220:	89 c2                	mov    %eax,%edx
80108222:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108225:	89 10                	mov    %edx,(%eax)
}
80108227:	c9                   	leave  
80108228:	c3                   	ret    
...
8010822d:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108230:	e8 b0 f9 ff ff       	call   80107be5 <setupkvm>
80108235:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108238:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010823c:	75 0a                	jne    80108248 <copyuvm+0x1f>
    return 0;
8010823e:	b8 00 00 00 00       	mov    $0x0,%eax
80108243:	e9 fd 00 00 00       	jmp    80108345 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108248:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010824f:	e9 d0 00 00 00       	jmp    80108324 <copyuvm+0xfb>
...
80108269:	e8 3d f8 ff ff       	call   80107aab <walkpgdir>
8010826e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108271:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108275:	75 0c                	jne    80108283 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108277:	c7 04 24 0a 8b 10 80 	movl   $0x80108b0a,(%esp)
8010827e:	e8 b7 82 ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
80108283:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108286:	8b 00                	mov    (%eax),%eax
80108288:	83 e0 01             	and    $0x1,%eax
8010828b:	85 c0                	test   %eax,%eax
8010828d:	75 0c                	jne    8010829b <copyuvm+0x72>
      panic("copyuvm: page not present");
8010828f:	c7 04 24 24 8b 10 80 	movl   $0x80108b24,(%esp)
80108296:	e8 9f 82 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
8010829b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010829e:	8b 00                	mov    (%eax),%eax
801082a0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801082a5:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
801082a8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082ab:	8b 00                	mov    (%eax),%eax
801082ad:	25 ff 0f 00 00       	and    $0xfff,%eax
801082b2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801082b5:	e8 c3 a8 ff ff       	call   80102b7d <kalloc>
801082ba:	89 45 e0             	mov    %eax,-0x20(%ebp)
801082bd:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801082c1:	75 02                	jne    801082c5 <copyuvm+0x9c>
      goto bad;
801082c3:	eb 70                	jmp    80108335 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
801082c5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082c8:	89 04 24             	mov    %eax,(%esp)
801082cb:	e8 58 f3 ff ff       	call   80107628 <p2v>
...
801082e2:	e8 c5 ce ff ff       	call   801051ac <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
801082e7:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801082ea:	8b 45 e0             	mov    -0x20(%ebp),%eax
801082ed:	89 04 24             	mov    %eax,(%esp)
801082f0:	e8 26 f3 ff ff       	call   8010761b <v2p>
801082f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801082f8:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801082fc:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108300:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108307:	00 
80108308:	89 54 24 04          	mov    %edx,0x4(%esp)
8010830c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010830f:	89 04 24             	mov    %eax,(%esp)
80108312:	e8 36 f8 ff ff       	call   80107b4d <mappages>
80108317:	85 c0                	test   %eax,%eax
80108319:	79 02                	jns    8010831d <copyuvm+0xf4>
      goto bad;
8010831b:	eb 18                	jmp    80108335 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
...
8010832a:	0f 82 24 ff ff ff    	jb     80108254 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108333:	eb 10                	jmp    80108345 <copyuvm+0x11c>

bad:
  freevm(d);
80108335:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108338:	89 04 24             	mov    %eax,(%esp)
8010833b:	e8 09 fe ff ff       	call   80108149 <freevm>
  return 0;
80108340:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108345:	83 c4 44             	add    $0x44,%esp
80108348:	5b                   	pop    %ebx
80108349:	5d                   	pop    %ebp
8010834a:	c3                   	ret    
...
8010834e:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80108351:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108358:	00 
...
80108366:	e8 40 f7 ff ff       	call   80107aab <walkpgdir>
...
801083a1:	e8 82 f2 ff ff       	call   80107628 <p2v>
}
801083a6:	c9                   	leave  
801083a7:	c3                   	ret    
...
801083ab:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
801083b1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801083b4:	e9 87 00 00 00       	jmp    80108440 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
801083b9:	8b 45 0c             	mov    0xc(%ebp),%eax
801083bc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801083c1:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
801083d1:	e8 75 ff ff ff       	call   8010834b <uva2ka>
801083d6:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801083d9:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801083dd:	75 07                	jne    801083e6 <copyout+0x3e>
      return -1;
801083df:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801083e4:	eb 69                	jmp    8010844f <copyout+0xa7>
    n = PGSIZE - (va - va0);
801083e6:	8b 45 0c             	mov    0xc(%ebp),%eax
801083e9:	8b 55 ec             	mov    -0x14(%ebp),%edx
801083ec:	29 c2                	sub    %eax,%edx
801083ee:	89 d0                	mov    %edx,%eax
801083f0:	05 00 10 00 00       	add    $0x1000,%eax
801083f5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801083f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083fb:	3b 45 14             	cmp    0x14(%ebp),%eax
801083fe:	76 06                	jbe    80108406 <copyout+0x5e>
      n = len;
80108400:	8b 45 14             	mov    0x14(%ebp),%eax
80108403:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108406:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108409:	8b 55 0c             	mov    0xc(%ebp),%edx
8010840c:	29 c2                	sub    %eax,%edx
8010840e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108411:	01 c2                	add    %eax,%edx
80108413:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108416:	89 44 24 08          	mov    %eax,0x8(%esp)
8010841a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010841d:	89 44 24 04          	mov    %eax,0x4(%esp)
80108421:	89 14 24             	mov    %edx,(%esp)
80108424:	e8 83 cd ff ff       	call   801051ac <memmove>
    len -= n;
80108429:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010842c:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010842f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108432:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108435:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108438:	05 00 10 00 00       	add    $0x1000,%eax
8010843d:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108440:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108444:	0f 85 6f ff ff ff    	jne    801083b9 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
